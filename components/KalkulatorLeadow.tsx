...
/*
 * Komplet danych, gotowe ukladki i sam wzor siedza w lib/koszt-leadow.ts,
 * bo ten sam rachunek liczy skrocony blok na stronie glownej.
 */
type Inputs = DaneLeadow;
const DEFAULTS = DOMYSLNE_LEADOW;
const SCENARIUSZE: Scenariusz<Inputs>[] = SCENARIUSZE_LEADOW;
...
export default function KalkulatorLeadow() {
  ...
  const result = useMemo(() => policzKosztLeadow(data), [data]);
