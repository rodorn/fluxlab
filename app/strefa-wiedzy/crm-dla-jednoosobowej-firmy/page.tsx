        ...
        <div className="container-wide pb-8">
          <Tabs
            ...
            tabs={[
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        Jednoosobowa firma nie potrzebuje rozbudowanego
                        pipeline, workflow z 20 krokami ani marketing
                        automation. Potrzebuje odpowiedzi na trzy pytania:
                      </p>
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        ...
                        użytkownika. Dostajesz pipeline, deale, zadania,
                        integrację ze skrzynką i kalendarzem oraz proste
                        raporty. Dla solo consultanta to absolutnie
                        wystarczająca konfiguracja.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        Plus: bardzo szybki start, czysty widok pracy. Minus:
                        nie ma sensownego planu darmowego, więc to zawsze koszt.
                        Jeśli chcesz wycisnąć z niego maksimum, warto wesprzeć
                        go{" "}
                        <Link
              ...
              {
                label: "Folk, Attio, Monday, Notion",
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        ...
                        Gmailem i Slackiem. Plus: nowoczesny UX, świetnie pasuje
                        do pracy na relacjach. Minus: ekosystem jest mniejszy
                        niż Pipedrive/HubSpot.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        ...
                        Monday.com. Dla jednoosobowej firmy to sensowny wybór
                        tylko wtedy, gdy i tak prowadzisz na Monday projekty
                        albo operacje. Wtedy CRM siedzi „w domu" obok
                        pozostałych boardów.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        Notion nie jest CRM-em, ale wielu solo konsultantów
                        używa go jako lekkiej bazy: tabela kontaktów, lista
                        deali, board z etapami, notatki ze spotkań w jednym
                        miejscu. Plus: zerowa nauka, jeśli już używasz Notion.
                        Wszystko jest tam, gdzie trzymasz resztę pracy.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Minus: brak pełnej integracji ze skrzynką i kalendarzem,
                        słabsze przypomnienia, brak natywnego workflow. Sprawdza
                        się przy małych wolumenach (do kilkudziesięciu aktywnych
              ...
              {
                label: "Sheets, czego unikać, jak wybrać",
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        ...
                        kolumnami kontakt, status, data ostatniego kontaktu,
                        kolejny krok, deadline. Do tego automatyzacja w
                        Make/n8n/Apps Script: nowy lead z formularza,
                        przypomnienie o follow-upie, raport tygodniowy na maila.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        Plus: 0 zł, pełna kontrola, łatwe eksporty i raporty.
                        Minus: wymaga dyscypliny, bo nikt Cię nie pilnuje.
                        Świetnie sprawdza się dla osób, które myślą procesowo.
                        Dla wielu solo to ostatnia szczerze potrzebna „warstwa"
                        CRM przed realnym wzrostem zespołu.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        ...
                        przyszłość". Płacisz miesięcznie kilkaset USD za
                        funkcje, z których realnie nie korzystasz. Lepiej zacząć
                        od Free albo Pipedrive, a do Pro przejść wtedy, gdy
                        faktycznie zatrudnisz drugą osobę.
                      </p>
                      ...
                      <p className="mt-6 text-gray-600 dark:text-gray-400 leading-relaxed">
                        Jeśli dopiero zaczynasz, warto przejść przez listę
                        kroków z artykułu{" "}
                        <Link
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        ...
                        powinna mieć ustawione trzy podstawowe przepływy, żeby
                        CRM realnie pracował, a nie tylko trzymał dane.
                      </p>
                      <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                        <li className="flex items-start gap-2">
                          {checkIcon}
                        ...
                        <li className="flex items-start gap-2">
                          {checkIcon}
                          Raport tygodniowy na maila: aktywne deale, wartości,
                          brak follow-upu powyżej X dni.
                        </li>
                      </ul>
                      <p className="mt-6 text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        Te trzy elementy dają solo consultantowi większą
                        kontrolę niż najbardziej rozbudowany CRM bez
                        automatyzacji. W Pipedrive zrobisz to natywnie, w
                        HubSpot Free przez proste workflow (często pomaga
                        Make/n8n jako nakładka), w Sheets przez Apps Script lub
                        webhook do Make.
                      </p>
                      ...
                      <p className="mt-6 text-gray-600 dark:text-gray-400 leading-relaxed">
                        Niezależnie od wyboru, różnicę w zwrocie robi dopiero
                        dobrze zaplanowana{" "}
                        <Link
                          href="/strefa-wiedzy/automatyzacja-crm-od-czego-zaczac"
                          className="text-accent hover:underline"
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            jednocześnie, tak. Bez systemu zaczynasz tracić
                            leady, do których po prostu nie wracasz na czas.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            aktywnych rozmowach i mocno relacyjnym modelu
                            sprzedaży. Powyżej tego brak natywnych przypomnień i
                            integracji zaczyna boleć.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            Nie. Salesforce dla jednej osoby jest
                            niewspółmiernie drogi i ciężki w utrzymaniu.
                            Migrację na Salesforce rób wtedy, gdy realnie masz
                            zespół i procesy, które tego wymagają.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            dyscypliną i podłączysz proste automatyzacje (Make,
                            n8n, Apps Script). Dla wielu solo to optymalne
                            narzędzie zanim pojawi się drugi człowiek w firmie.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            Attio mocniej elastyczny, lepszy do firm
                            operacyjnych i VC. Dla typowego solo consultanta
                            zwykle wygodniejszy jest Folk.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
