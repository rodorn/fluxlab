        ...
        <div className="container-wide pb-20">
          <Tabs
            ...
            tabs={[
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Stawki od 2% do 17%, zależne od rodzaju działalności
                          (PKD)
                        </li>
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Liniowy daje przewidywalność i pełną kontrolę nad
                        kosztami. Im wyższe koszty, tym niższy dochód, tym
                        niższy podatek i niższa składka zdrowotna.
                      </p>
                    </div>
                  </div>
                ),
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          Twój przychód jest na tyle wysoki, że składka
                          zdrowotna na liniowym (4,9% dochodu) byłaby wyższa niż
              ...
              {
                label: "Przykłady i składka zdrowotna",
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Przychód roczny: 180 000 zł. Koszty: 1 500 zł/mies. (18
                        000 zł/rok). Stawka ryczałtu: 12%.
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Przychód roczny: 240 000 zł. Koszty: 8 000 zł/mies. (96
                        000 zł/rok). Stawka ryczałtu: 15%.
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Przychód roczny: 144 000 zł. Koszty: 3 500 zł/mies. (42
                        000 zł/rok). Stawka ryczałtu: 12%.
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        który przesądza o wyniku porównania. Na ryczałcie jest
                        zryczałtowana i relatywnie niska. Na liniowym wynosi
                        4,9% dochodu, ale można ją częściowo odliczyć.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        liczy się od przychodu, a liniowy od dochodu. Jeśli masz
                        40% kosztów, efektywna stawka liniowego od przychodu to
                        19% x 60% = 11,4%. Mniej niż 12% ryczałtu.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        i jej mechanizm jest zupełnie inny na ryczałcie i
                        liniowym. Porównanie bez niej jest niepełne.
                      </p>
