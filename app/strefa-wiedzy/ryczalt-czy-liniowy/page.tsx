            ...
            <article>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    tego, co wpłynęło na konto (pomniejszone o VAT, jeśli jesteś
                    VATowcem).
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      ...
                      rocznego przychodu (ok. 420, 700 lub 940 zł miesięcznie w
                      2026)
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    kosztach. Ale brak odliczenia kosztów to poważna wada, jeśli
                    wydajesz dużo na prowadzenie działalności.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    przychodu pomniejszonego o koszty uzyskania przychodu. Nie
                    ma progów, nie ma kwoty wolnej — ale możesz odliczać
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      Odliczenie składki zdrowotnej od podstawy opodatkowania do
                      limitu 12 900 zł rocznie
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    Im wyższe koszty, tym niższy dochód, tym niższy podatek i
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>Twoja stawka ryczałtu jest niska — 12% lub mniej</li>
                    <li>
                      Nie planujesz dużych zakupów (sprzęt, samochód, remont
                      biura)
                    </li>
                    <li>
                      Twój przychód jest na tyle wysoki, że składka zdrowotna na
                      liniowym (4,9% dochodu) byłaby wyższa niż zryczałtowana na
                      ryczałcie
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Typowy profil: freelancer IT na B2B, przychód 15–25 tys. zł
                    miesięcznie, koszty poniżej 2 000 zł, stawka ryczałtu 12%. W
                    takim scenariuszu ryczałt zwykle oszczędza od kilku do
                    kilkunastu tysięcy złotych rocznie w porównaniu z liniowym.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Koszty uzyskania przychodu przekraczają 30–40% przychodu
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    usługowej, przychód 20–30 tys. zł miesięcznie, koszty 6–10
                    tys. zł (podwykonawcy, samochód, biuro, narzędzia). Na
                    ryczałcie zapłaciłby podatek od pełnych 20–30 tys., na
                    liniowym tylko od 10–20 tys.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przychód roczny: 180 000 zł. Koszty: 1 500 zł/mies. (18 000
                    zł/rok). Stawka ryczałtu: 12%.
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Ryczałt: podatek 12% x 180 000 = 21 600 zł. Składka
                      zdrowotna zryczałtowana ok. 8 400 zł/rok (po odliczeniu
                      50%). Łącznie ok. 30 000 zł.
                    </li>
                    <li>
                      Liniowy: dochód 162 000 zł. Podatek 19% x (162 000 - 12
                      900 odliczenie zdrowotnej) = ok. 28 300 zł. Składka
                      zdrowotna 4,9% x 162 000 = 7 938 zł. Łącznie ok. 36 200
                      zł.
                    </li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przychód roczny: 240 000 zł. Koszty: 8 000 zł/mies. (96 000
                    zł/rok). Stawka ryczałtu: 15%.
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Ryczałt: podatek 15% x 240 000 = 36 000 zł. Składka
                      zdrowotna ok. 11 300 zł/rok (po odliczeniu 50%). Łącznie
                      ok. 47 300 zł.
                    </li>
                    <li>
                      Liniowy: dochód 144 000 zł. Podatek 19% x (144 000 - 12
                      900) = ok. 24 900 zł. Składka zdrowotna 4,9% x 144 000 = 7
                      056 zł. Łącznie ok. 31 950 zł.
                    </li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przychód roczny: 144 000 zł. Koszty: 3 500 zł/mies. (42 000
                    zł/rok). Stawka ryczałtu: 12%.
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                    ...
                    <li>
                      Liniowy: dochód 102 000 zł. Podatek 19% x (102 000 - 12
                      900) = ok. 16 929 zł. Składka zdrowotna 4,9% x 102 000 = 4
                      998 zł. Łącznie ok. 21 927 zł.
                    </li>
                    <li>
                      Wynik: liniowy oszczędza ok. 3 750 zł rocznie. Ale przy
                      kosztach poniżej 2 500 zł/mies. ryczałt zaczyna wygrywać.
                    </li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    proporcjonalnie do przychodu (są trzy progi), a na liniowym
                    rośnie razem z dochodem. Przy wysokim dochodzie i niskich
                    kosztach różnica w składce zdrowotnej może wynosić nawet
                    kilka tysięcy złotych rocznie na korzyść ryczałtu.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Pełne wyjaśnienie zasad składki zdrowotnej na każdej formie
                    znajdziesz w{" "}
                    <Link
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    liczy się od przychodu, a liniowy od dochodu. Jeśli masz 40%
                    kosztów, efektywna stawka liniowego od przychodu to 19% x
                    60% = 11,4%. Mniej niż 12% ryczałtu.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Porównanie samego podatku to za mało. Składka zdrowotna to
                    dodatkowe kilka do kilkunastu tysięcy złotych rocznie i jej
                    mechanizm jest zupełnie inny na ryczałcie i liniowym.
                    Porównanie bez niej jest niepełne.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Samochód w leasingu to jeden z najczęstszych kosztów w JDG.
                    Na ryczałcie nie odliczysz rat leasingu, paliwa ani
                    eksploatacji. Na liniowym — tak. Jeśli samochód kosztuje Cię
                    3 000 zł miesięcznie, to 36 000 zł rocznie nieodliczonych
                    kosztów.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przychody i koszty zmieniają się z roku na rok. Forma, która
                    była optymalna w zeszłym roku, może nie być optymalna w tym.
                    Warto przeliczyć przed 20 lutego każdego roku.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Ryczałt i liniowy to dwie dobre formy opodatkowania, ale dla
                    różnych sytuacji. Ryczałt wygrywa przy niskich kosztach i
                    korzystnej stawce. Liniowy wygrywa przy wysokich kosztach i
                    droższych stawkach ryczałtu.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Klucz do dobrej decyzji: nie patrzeć na samą stawkę
                    podatkową, ale na łączne obciążenie — podatek plus składka
                    zdrowotna, z uwzględnieniem kosztów. A najlepiej — policzyć
                    na konkretnych liczbach w kalkulatorze.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Pamiętaj: zmiana formy jest możliwa raz w roku, do 20
                    lutego. To niewiele czasu na decyzję, która wpływa na cały
                    rok podatkowy.
                  </p>
                </div>
              </section>
