            ...
            <article>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    wynosi 80 zł, to mówimy o 1600 zł miesięcznie i 19&nbsp;200
                    zł rocznie.
                  </p>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    24 godziny. Koszt godziny 85 zł = 2040 zł/mies = 24&nbsp;480
                    zł/rok.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    . 2,5h na raport, 2 osoby, co tydzień = 20h/mies. Koszt 100
                    zł/h = 2000 zł/mies = 24&nbsp;000 zł/rok.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    handlowiec dostaje powiadomienie, follow-up jest zaplanowany
                    automatycznie. Czas reakcji spadł z kilku godzin do kilku
                    minut.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ROI było dodatnie jeszcze zanim policzono miękkie korzyści:
                    mniej stresu, mniej pytań &bdquo;kto to miał zrobić&rdquo;,
                    lepsze nastroje w zespole.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Zespół operacyjny co tydzień zbiera dane z trzech systemów,
                    skleja je w Excelu i wysyła raport do zarządu. Proces trwa
                    kilka godzin, a dane i tak bywają niespójne. Zaufanie do
                    raportów jest niskie, a decyzje opóźnione.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
