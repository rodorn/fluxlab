            ...
            <article>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    Jeśli nie wybierzesz innej, automatycznie rozliczasz się na
                    skali. Oto jej kluczowe parametry w 2026 roku:
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Kwota wolna od podatku: 30 000 zł — od pierwszych 30 000
                      zł dochodu nie płacisz podatku dochodowego
                    </li>
                    <li>
                      I próg: 12% od dochodu do 120 000 zł (po odliczeniu kwoty
                      wolnej)
                    </li>
                    <li>II próg: 32% od dochodu powyżej 120 000 zł</li>
                    <li>Koszty uzyskania przychodu: tak, pełne odliczenie</li>
                    <li>
                      Składka zdrowotna: 9% dochodu, nieodliczalna od podatku
                      ani od podstawy opodatkowania
                    </li>
                    <li>Wspólne rozliczenie z małżonkiem: tak, dostępne</li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Kwota wolna 30 000 zł to istotna przewaga. Oznacza, że
                    pierwsze 30 000 zł dochodu jest efektywnie nieopodatkowane.
                    Przy dochodzie 120 000 zł efektywna stawka podatkowa wynosi
                    ok. 8,8% — znacznie mniej niż nominalne 12%.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>Wspólne rozliczenie z małżonkiem: nie, niedostępne</li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Brak kwoty wolnej oznacza, że od pierwszej złotówki dochodu
                    płacisz 19%. Ale niższa składka zdrowotna (4,9% vs 9%) i
                    możliwość jej odliczenia częściowo rekompensują tę wadę przy
                    wyższych dochodach.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przy dochodzie 200 000 zł: składka zdrowotna na skali to 18
                    000 zł (nieodliczalna), na liniowym to 9 800 zł (odliczalna
                    do 12 900 zł). Różnica w samej składce: ponad 8 000 zł.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    kluczowe pytanie. Odpowiedź nie jest jednoznaczna, bo zależy
                    od składki zdrowotnej, ale można podać orientacyjne ramy.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    wolna. Efektywna stawka przy 120 000 zł to ok. 8,8%. Przy
                    150 000 zł efektywna stawka rośnie do ok. 14,4% (wchodzisz w
                    próg 32%). Na liniowym: zawsze 19%.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Gdyby liczyć sam podatek, próg opłacalności wynosiłby ok.
                    135–140 tys. zł dochodu rocznie.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Składka zdrowotna przesuwa próg w dół. Na skali jest wyższa
                    (9% vs 4,9%) i nieodliczalna. To sprawia, że łączne
                    obciążenie na skali rośnie szybciej.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Po uwzględnieniu składki zdrowotnej, próg opłacalności
                    przesuwa się do ok. 100–120 tys. zł dochodu rocznie. Przy
                    dochodzie powyżej 120 tys. zł liniowy jest niemal zawsze
                    korzystniejszy, jeśli nie potrzebujesz wspólnego rozliczenia
                    z małżonkiem.
                  </p>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      ...
                      Składka zdrowotna = 9% x 110 000 = 9 900 zł. Łącznie: 19
                      500 zł.
                    </li>
                    <li>
                      Liniowy: składka zdrowotna = 4,9% x 110 000 = 5 390 zł.
                      Odliczenie zdrowotnej: 5 390 zł (mieści się w limicie).
                      Podatek = 19% x (110 000 - 5 390) = 19 876 zł. Łącznie: 25
                      266 zł.
                    </li>
                    <li>Wynik: skala wygrywa o ok. 5 766 zł.</li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Skala: podatek = 12% x 90 000 + 32% x 30 000 = 10 800 + 9
                      600 = 20 400 zł. Składka zdrowotna = 9% x 150 000 = 13 500
                      zł. Łącznie: 33 900 zł.
                    </li>
                    <li>
                      Liniowy: składka zdrowotna = 4,9% x 150 000 = 7 350 zł.
                      Odliczenie zdrowotnej: 7 350 zł. Podatek = 19% x (150 000
                      - 7 350) = 27 104 zł. Łącznie: 34 454 zł.
                    </li>
                    <li>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    zdecydowanie. Kwota wolna 30 000 zł obniża podstawę do 50
                    000 zł, a stawka 12% daje podatek 6 000 zł. Na liniowym bez
                    kwoty wolnej: 19% x 80 000 = 15 200 zł (minus odliczenie
                    zdrowotnej).
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                    ...
                    <li>
                      Liniowy: zdrowotna 3 920 zł, podatek 19% x (80 000 - 3
                      920) = 14 455 zł. Łącznie 18 375 zł.
                    </li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przy 150 000 zł wchodzisz w II próg skali (32%). Różnica w
                    składce zdrowotnej (9% vs 4,9%) zaczyna odgrywać kluczową
                    rolę.
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Skala: podatek 20 400 zł + zdrowotna 13 500 zł = 33 900 zł
                    </li>
                    <li>
                      Liniowy: zdrowotna 7 350 zł, podatek 27 104 zł. Łącznie 34
                      454 zł.
                    </li>
                    <li>
                      Wynik: niemal remis. Skala minimalnie tańsza, ale różnica
                      jest symboliczna.
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Skala: podatek 12% x 90 000 + 32% x 80 000 = 10 800 + 25
                      600 = 36 400 zł. Zdrowotna 18 000 zł. Łącznie 54 400 zł.
                    </li>
                    <li>
                      Liniowy: zdrowotna 9 800 zł, podatek 19% x (200 000 - 12
                      900) = 35 549 zł. Łącznie 45 349 zł.
                    </li>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    zdrowotna, skala byłaby korzystniejsza aż do dochodu ok.
                    135–140 tys. zł. Ale składka zdrowotna przesuwa ten próg w
                    dół.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Składka zdrowotna na skali wynosi 9% dochodu. Nie można jej
                    odliczyć ani od podatku, ani od podstawy opodatkowania. To
                    czysty, dodatkowy koszt. Przy dochodzie 120 000 zł to 10 800
                    zł rocznie, które po prostu znikają z konta.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Na liniowym składka zdrowotna wynosi 4,9% dochodu — niemal o
                    połowę mniej. Dodatkowo można ją odliczyć od podstawy
                    opodatkowania do limitu 12 900 zł rocznie. To podwójna
                    korzyść: niższa składka i częściowy zwrot w postaci niższego
                    podatku.
                  </p>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      Liniowy: zdrowotna = 8 820 zł, z czego 8 820 zł odliczasz
                      od podstawy (mieści się w limicie 12 900 zł), co obniża
                      podatek o ok. 1 676 zł
                    </li>
                    <li>
                      Różnica w składce: 7 380 zł. Plus efekt odliczenia: ok. 1
                      676 zł. Łącznie na korzyść liniowego: ok. 9 056 zł
                    </li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    wyłącznie na skali podatkowej. Na liniowym nie ma takiej
                    możliwości.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Jak to działa: łączny dochód obojga małżonków dzieli się na
                    pół, a podatek liczy się od połowy — i mnoży przez dwa.
                    Efekt: jeśli jeden małżonek zarabia dużo (np. powyżej progu
                    32%), a drugi mało lub wcale, wspólne rozliczenie pozwala
                    uniknąć wyższego progu.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przykład: Twój dochód to 200 000 zł, małżonek zarabia 20 000
                    zł. Łącznie 220 000 zł, podzielone na pół = 110 000 zł.
                    Oboje mieszczą się w I progu (12%), zamiast jednego w II
                    progu (32%).
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Bez wspólnego rozliczenia: podatek od 200 000 zł = 36 400
                      zł (12% x 90k + 32% x 80k)
                    </li>
                    <li>
                      Ze wspólnym: podatek od 2 x 110 000 zł = 2 x 9 600 zł = 19
                      200 zł
                    </li>
                    <li>Oszczędność: 17 200 zł na samym podatku</li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    To ogromna przewaga skali nad liniowym, szczególnie przy
                    dużej dysproporcji dochodów między małżonkami. Jeśli to
                    Twoja sytuacja, skala może być korzystniejsza nawet przy
                    dochodzie powyżej 150 tys. zł.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>Twój roczny dochód nie przekracza 100–120 tys. zł</li>
                    <li>Chcesz rozliczać się wspólnie z małżonkiem</li>
                    <li>Kwota wolna 30 000 zł daje Ci realną korzyść</li>
                    <li>
                      Masz inne dochody opodatkowane na skali (np. umowa o
                      pracę) i chcesz je łączyć
                    </li>
                    <li>
                      Planujesz korzystać z ulg podatkowych dostępnych na skali
                      (np. ulga na dzieci)
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>Twój roczny dochód przekracza 120–150 tys. zł</li>
                    <li>Nie potrzebujesz wspólnego rozliczenia z małżonkiem</li>
                    <li>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    dochodach dzięki kwocie wolnej i stawce 12%. Liniowy wygrywa
                    przy wyższych dochodach dzięki stałej stawce 19% i niższej
                    składce zdrowotnej.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Próg opłacalności to ok. 100–120 tys. zł dochodu rocznie,
                    ale składka zdrowotna i możliwość wspólnego rozliczenia z
                    małżonkiem mogą go przesunąć w jedną lub drugą stronę.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Najważniejsza rada: nie porównuj samych stawek podatkowych.
                    Licz łączne obciążenie — podatek plus składka zdrowotna. I
                    policz na swoich liczbach, bo ogólne zasady dają tylko
