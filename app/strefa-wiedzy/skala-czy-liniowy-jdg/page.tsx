                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        Polsce. Jeśli nie wybierzesz innej, automatycznie
                        rozliczasz się na skali. Oto jej kluczowe parametry w
                        2026 roku:
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          Składka zdrowotna: 9% dochodu, nieodliczalna od
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        vs 9%) i możliwość jej odliczenia częściowo rekompensują
                        tę wadę przy wyższych dochodach.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        zależy od składki zdrowotnej, ale można podać
                        orientacyjne ramy.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        Przy dochodzie powyżej 120 tys. zł liniowy jest niemal
                        zawsze korzystniejszy, jeśli nie potrzebujesz wspólnego
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          Liniowy: składka zdrowotna = 4,9% x 110 000 = 5 390
                          zł. Odliczenie zdrowotnej: 5 390 zł (mieści się w
                          limicie). Podatek = 19% x (110 000 - 5 390) = 19 876
                          zł. Łącznie: 25 266 zł.
                        </li>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Skala: podatek = 12% x 90 000 + 32% x 30 000 = 10 800
                          + 9 600 = 20 400 zł. Składka zdrowotna = 9% x 150 000
                          = 13 500 zł. Łącznie: 33 900 zł.
                        </li>
                        <li>
                          Liniowy: składka zdrowotna = 4,9% x 150 000 = 7 350
                          zł. Odliczenie zdrowotnej: 7 350 zł. Podatek = 19% x
                          (150 000 - 7 350) = 27 104 zł. Łącznie: 34 454 zł.
                        </li>
                        <li>
                          Wynik: skala minimalnie tańsza (o ok. 554 zł), ale
                          przy dochodzie 160 000 zł liniowy już wygrywa.
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Skala: podatek 6 000 zł + zdrowotna 7 200 zł = 13 200
                          zł
                        </li>
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Przy 150 000 zł wchodzisz w II próg skali (32%). Różnica
                        w składce zdrowotnej (9% vs 4,9%) zaczyna odgrywać
                        kluczową rolę.
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Skala: podatek 20 400 zł + zdrowotna 13 500 zł = 33
                          900 zł
                        </li>
                        <li>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Skala: podatek 12% x 90 000 + 32% x 80 000 = 10 800 +
                          25 600 = 36 400 zł. Zdrowotna 18 000 zł. Łącznie 54
                          400 zł.
                        </li>
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        135–140 tys. zł. Ale składka zdrowotna przesuwa ten próg
                        w dół.
                      </p>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          ...
                          ok. 1 676 zł. Łącznie na korzyść liniowego: ok. 9 056
                          zł
                        </li>
                      </ul>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Przykład: Twój dochód to 200 000 zł, małżonek zarabia 20
                        000 zł. Łącznie 220 000 zł, podzielone na pół = 110 000
                        zł. Oboje mieszczą się w I progu (12%), zamiast jednego
                        w II progu (32%).
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Bez wspólnego rozliczenia: podatek od 200 000 zł = 36
                          400 zł (12% x 90k + 32% x 80k)
                        </li>
                        <li>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          Planujesz korzystać z ulg podatkowych dostępnych na
                          skali (np. ulga na dzieci)
                        </li>
                      </ul>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Skala podatkowa i podatek liniowy to dwa dobre
                        rozwiązania dla różnych poziomów dochodu. Skala wygrywa
                        przy niższych dochodach dzięki kwocie wolnej i stawce
                        12%. Liniowy wygrywa przy wyższych dochodach dzięki
                        stałej stawce 19% i niższej składce zdrowotnej.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Próg opłacalności to ok. 100–120 tys. zł dochodu
                        rocznie, ale składka zdrowotna i możliwość wspólnego
                        rozliczenia z małżonkiem mogą go przesunąć w jedną lub
                        drugą stronę.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
