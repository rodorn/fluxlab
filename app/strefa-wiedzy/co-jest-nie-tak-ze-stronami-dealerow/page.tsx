    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 pb-20 pt-28 md:pt-32">
        ...
        <SprawdzPoBadaniu
          ...
          opis="Otwieramy stronę główną, kontakt i regulamin wybranej domeny, szukamy numeru NIP i numeru konta, a znaleziony NIP zestawiamy z wykazem podatników VAT. Tak samo, jak przy 386 domenach z tego badania."
