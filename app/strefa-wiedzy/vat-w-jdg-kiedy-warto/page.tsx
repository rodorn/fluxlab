        ...
        <section className="bg-gray-50 dark:bg-gray-900/50 py-20 lg:py-28">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              czy osobami prywatnymi (B2C), i jak dużo wydajesz na koszty objęte
              VAT.
            </p>
          </div>
        </section>
            ...
            <article>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Jeśli Twój roczny obrót (sprzedaż) nie przekracza 200 000
                    zł, możesz korzystać ze zwolnienia podmiotowego z VAT.
                    Oznacza to, że:
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    w danym roku kalendarzowym. Jeśli zaczynasz działalność w
                    trakcie roku, limit jest proporcjonalny do liczby
                    pozostałych dni.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Przekroczenie progu 200 000 zł obrotu w roku kalendarzowym
                      — obowiązek rejestracji od momentu przekroczenia
                    </li>
                    <li>
                      Sprzedaż towarów wymienionych w załączniku nr 12 do ustawy
                      o VAT (m.in. metale szlachetne, elektronika, paliwa)
                    </li>
                    <li>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Niektóre firmy wolą współpracować z vatowcami. Brak VAT na
                    fakturze bywa postrzegany jako sygnał, że firma jest bardzo
                    mała lub dopiero zaczyna. To nie jest argument finansowy,
                    ale w niektórych branżach ma znaczenie.
                  </p>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    brutto (końcowa). Jeśli jesteś vatowcem, Twoja usługa za 1
                    000 zł netto kosztuje klienta 1 230 zł brutto. Jeśli nie
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Jeśli Twoje koszty to głównie wynagrodzenia, składki ZUS lub
                    usługi zwolnione z VAT — nie masz dużo VAT do odliczenia. W
                    takiej sytuacji bycie vatowcem generuje tylko dodatkową
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Czynny VAT oznacza obowiązek prowadzenia ewidencji VAT i
                    składania JPK_V7 co miesiąc. Nawet jeśli rozliczasz VAT
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    klientów, ale ten VAT nie jest Twoim przychodem — musisz go
                    odprowadzić do urzędu skarbowego.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    W praktyce oznacza to, że na koncie firmowym widzisz więcej
                    pieniędzy niż naprawdę masz. Jeśli wystawiasz fakturę na 10
                    000 zł netto + 2 300 zł VAT, na konto wpływa 12 300 zł. Ale
                    2 300 zł (pomniejszone o VAT z Twoich zakupów) musisz oddać.
                  </p>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                    Terminy rozliczeń
                  </h3>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      ...
                      (obrót do 2 mln EUR), VAT płacisz do 25. dnia miesiąca po
                      kwartale
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Dlatego warto odkładać VAT na osobne subkonto od razu po
                    wystawieniu faktury. Dzięki temu nie wydasz pieniędzy, które
                    nie są Twoje.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    VAT i podatek dochodowy (PIT) to dwa osobne podatki. Decyzja
                    o VAT jest niezależna od wyboru formy opodatkowania. Możesz
                    łączyć status czynnego vatowca z każdą formą:
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>Ryczałt + czynny VAT — tak, to możliwe i częste</li>
                    <li>
                      Podatek liniowy + czynny VAT — standardowa kombinacja dla
                      B2B
                    </li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    ryczałcie nie odliczasz kosztów od przychodu (ale VAT od
                    zakupów i tak odliczasz, jeśli jesteś vatowcem). Na liniowym
                    i skali koszty netto pomniejszają dochód, a VAT od tych
                    kosztów odliczasz w deklaracji VAT.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      Musisz prowadzić szczegółową ewidencję przebiegu
                      (kilometrówkę)
                    </li>
                    <li>
                    ...
                    <li>
                      W praktyce trudne do utrzymania przy jednoosobowej
                      działalności
                    </li>
                  </ul>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    znacząca, ale wymogi dokumentacyjne przy 100% odliczeniu są
                    rygorystyczne.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Jeśli pracujesz B2B i masz koszty z VAT — rejestracja jako
                    czynny vatowiec prawie zawsze się opłaca. Odliczasz VAT od
                    zakupów, a klienci i tak patrzą na kwotę netto.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Jeśli pracujesz B2C i masz niskie koszty — zwolnienie
                    podmiotowe jest prostsze, tańsze administracyjnie i daje Ci
                    przewagę cenową (niższa cena brutto dla klienta końcowego).
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Pamiętaj: decyzję o VAT możesz zmienić. Możesz zarejestrować
                    się jako czynny VAT w dowolnym momencie, a zrezygnować po
                    minimum roku (jeśli obrót nie przekracza 200 000 zł). To nie
                    jest decyzja na zawsze.
                  </p>
                </div>
              </section>
                ...
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                        Tak. Forma opodatkowania PIT (ryczałt, liniowy, skala) i
                        status VAT to dwie osobne decyzje. Ryczałtowiec może być
                        czynnym vatowcem i odliczać VAT od zakupów — mimo że nie
                        odlicza kosztów od przychodu w PIT.
                      </p>
                    </details>
                    ...
                    <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                        ...
                        widoczne w usługach, gdzie cena jest kluczowym kryterium
                        wyboru.
                      </p>
                    </details>
                    ...
                    <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                        ...
                        VAT kwartalnie. Część ewidencyjna (rejestry sprzedaży i
                        zakupów) jest zawsze miesięczna. Część deklaracyjna może
                        być kwartalna dla małych podatników.
                      </p>
                    </details>
                  </div>
                </div>
