                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        000 zł, możesz korzystać ze zwolnienia podmiotowego z
                        VAT. Oznacza to, że:
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Limit 200 000 zł dotyczy wartości sprzedaży netto (bez
                        VAT) w danym roku kalendarzowym. Jeśli zaczynasz
                        działalność w trakcie roku, limit jest proporcjonalny do
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Warto pamiętać, że zwolnienie podmiotowe to nie to samo
                        co zwolnienie przedmiotowe (dotyczące określonych
                        rodzajów usług, np. medycznych czy edukacyjnych).
                      </p>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          Świadczenie usług prawniczych, doradczych,
                          jubilerskich
                        </li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Przy przekroczeniu progu 200 000 zł obowiązek
                        rejestracji powstaje od transakcji, która spowodowała
                        przekroczenie. Warto monitorować obrót na bieżąco, by
                        nie przeoczyć momentu, w którym zwolnienie przestaje
                        obowiązywać.
                      </p>
                    </div>
                  </div>
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Nawet jeśli Twój obrót nie przekracza 200 000 zł,
                        dobrowolna rejestracja jako czynny VAT może się opłacać.
                        Oto typowe sytuacje:
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        biurowe, samochód lub inne rzeczy objęte VAT, jako
                        czynny vatowiec odliczasz ten VAT. Przy kosztach 5 000
                        zł netto miesięcznie z 23% VAT, odliczasz 1 150 zł VAT
                        miesięcznie. Rocznie to 13 800 zł.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Rejestracja jako czynny VAT nie zawsze jest korzystna.
                        Oto sytuacje, w których zwolnienie podmiotowe może być
                        lepszym wyborem:
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Osoby prywatne nie odliczają VAT. Dla nich liczy się
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        kwartalnie, JPK_V7 (część ewidencyjna) składasz
                        miesięcznie. To dodatkowy czas i potencjalnie koszt
                        księgowości.
                      </p>
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        wpływa 12 300 zł. Ale 2 300 zł (pomniejszone o VAT z
                        Twoich zakupów) musisz oddać.
                      </p>
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                        Terminy rozliczeń
                      </h3>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        wystawieniu faktury. Dzięki temu nie wydasz pieniędzy,
                        które nie są Twoje.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        Decyzja o VAT jest niezależna od wyboru formy
                        opodatkowania. Możesz łączyć status czynnego vatowca z
                        każdą formą:
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        zakupów i tak odliczasz, jeśli jesteś vatowcem). Na
                        liniowym i skali koszty netto pomniejszają dochód, a VAT
                        od tych kosztów odliczasz w deklaracji VAT.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Więcej o wyborze formy opodatkowania znajdziesz w
                        artykule{" "}
                        <Link
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        których przedsiębiorcy rejestrują się jako czynni
                        vatowcy. Zasady odliczania VAT zależą od sposobu
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        ...
                        <li>
                          Samochód musi być zgłoszony w urzędzie skarbowym
                          (VAT-26)
                        </li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Decyzja o VAT zależy przede wszystkim od dwóch rzeczy:
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        zarejestrować się jako czynny VAT w dowolnym momencie, a
                        zrezygnować po minimum roku (jeśli obrót nie przekracza
                      ...
                      <div className="space-y-4">
                        <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                          ...
                          <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            ...
                            przekroczył 200 000 zł i nie prowadzisz
                            działalności, która wymaga bycia vatowcem.
                            Rezygnację zgłaszasz na formularzu VAT-R.
                          </p>
                        </details>
                        ...
                        <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                          ...
                          <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Często tak. Dla klienta indywidualnego liczy się
                            cena końcowa (brutto). Firma bez VAT może zaoferować
                            niższą cenę brutto przy tej samej marży. To
                            szczególnie widoczne w usługach, gdzie cena jest
