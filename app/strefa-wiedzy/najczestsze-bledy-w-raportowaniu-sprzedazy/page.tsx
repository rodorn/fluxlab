      ...
      <main className="pt-16">
        ...
        <section className="py-16 lg:py-24">
          <div className="container-wide">
              ...
              <article className="max-w-3xl mx-auto lg:mx-0 w-full space-y-16">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                    ...
                    zapytanie, a dla drugiej tylko kontakt zakwalifikowany, to
                    raport od początku jest fałszywy. To samo dotyczy sprzedaży,
                    szansy, spotkania czy utraty leada. Bez wspólnego słownika
                    nie ma rzetelnego raportowania.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                    ...
                    część w mailu, a końcowy raport ktoś skleja ręcznie. To
                    prawie gwarantuje opóźnienia, błędy i brak zaufania do
                    liczb. Im więcej ręcznego przeklejania, tym mniejsza
                    wiarygodność raportu. Rozwiązaniem jest{" "}
                    <Link
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                    Sama liczba leadów niewiele mówi, jeśli nie wiesz, jaka jest
                    ich jakość, czas reakcji, konwersja i wpływ na wynik. Firmy
                    często raportują to, co łatwo policzyć, zamiast tego, co
                    naprawdę pomaga zarządzać sprzedażą.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                    Jeżeli nikt nie odpowiada za jakość danych w CRM, raport
                    zawsze będzie miał wady. Dane nie poprawiają się same.
                  </p>
                </div>
            ...
            {/* CTA */}
            <div className="max-w-3xl mx-auto mt-16 rounded-2xl bg-gray-50 dark:bg-gray-900/50 p-8 lg:p-12 text-center">
