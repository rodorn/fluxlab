        ...
        <section className="pt-24 pb-10">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              przedsiębiorców o niższych przychodach. Pozwala płacić mniej niż
              przy pełnym ZUS, ale ma swoje warunki, limity i ograniczenia
              czasowe. Czy warto z niego korzystać? To zależy od przychodów,
              formy opodatkowania i tego, jak długo prowadzisz działalność.
            </p>
          </div>
        </section>
        ...
        <div className="container-wide pb-20">
          <Tabs
            ...
            tabs={[
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Podstawowa idea jest prosta: jeśli zarabiasz mniej,
                        płacisz mniejsze składki społeczne. Dzięki temu więcej
                        zostaje w kieszeni na bieżącą działalność. Ceną jest
                        jednak niższa podstawa do wyliczenia przyszłej
                        emerytury.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Mały ZUS Plus nie jest dostępny dla wszystkich. Musisz
                        spełnić kilka warunków jednocześnie:
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Przychód z działalności w poprzednim roku
                          kalendarzowym nie przekroczył 120 000 zł
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          z preferencyjnego ZUS (tzw. małego ZUS bez
                          &bdquo;Plus&rdquo;)
                        </li>
                        <li>
                          Nie rozliczałeś się w poprzednim roku na karcie
                          podatkowej z jednoczesnym zwolnieniem z VAT
                        </li>
                        <li>
                          Nie wykonujesz działalności na rzecz byłego pracodawcy
                          (ten sam zakres co na etacie w bieżącym lub poprzednim
                          roku)
                        </li>
                        <li>
                          Łączny okres korzystania z małego ZUS Plus nie
                          przekroczył 36 miesięcy w ciągu ostatnich 60 miesięcy
                        </li>
                      </ul>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              {
                label: "Porównanie i kiedy nie warto",
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-6">
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Brak składek społecznych (emerytalna, rentowa,
                          chorobowa, wypadkowa)
                        </li>
                        <li>Płacisz tylko składkę zdrowotną</li>
                        <li>
                          Dostępna przez 6 pełnych miesięcy od rozpoczęcia
                          działalności
                        </li>
                        <li>
                          Warunek: pierwsza działalność lub przerwa min. 60
                          miesięcy
                        </li>
                        <li>
                          Brak wpływu na emeryturę (brak składek = brak
                          kapitału)
                        </li>
                      </ul>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                          Podstawa wyliczana z dochodu z poprzedniego roku
                        </li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Mały ZUS Plus nie jest zawsze korzystny. Są sytuacje, w
                        których lepiej płacić pełne składki:
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Zgłoszenie do małego ZUS Plus składa się przez
                        deklarację ZUS DRA z kodem tytułu ubezpieczenia 0590xx
                        lub 0592xx. Termin zgłoszenia to:
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                        <li>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Wniosek składa się elektronicznie przez PUE ZUS (eZUS)
                        lub osobiście w oddziale ZUS. Do deklaracji trzeba
                        dołączyć informację o rocznym przychodzie i dochodzie z
                        poprzedniego roku (formularz ZUS DRA cz. II lub ZUS RCA
                        cz. II).
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Jeśli spóźnisz się z terminem, tracisz prawo do małego
                        ZUS Plus na cały rok. Nie ma możliwości zgłoszenia
                        wstecznego.
                      </p>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Mały ZUS Plus to realna oszczędność na składkach
                        społecznych dla przedsiębiorców z przychodem do 120 000
                        zł rocznie. Przy niskich dochodach oszczędność sięga
                        kilkuset złotych miesięcznie. Ale ma swoje warunki:
                        limit przychodowy, limit czasowy (36 miesięcy w ciągu
                        60) i konsekwencje emerytalne.
                      </p>
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-4">
                        Najważniejsze: nie przegap terminu zgłoszenia (31
                        stycznia lub 7 dni od spełnienia warunków). Bez
                        zgłoszenia nie ma ulgi.
                      </p>
                    </div>
                  </div>
                ),
                      ...
                      <div className="space-y-4">
                        <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                          ...
                          <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Nie. Mały ZUS Plus dotyczy wyłącznie składek
                            społecznych (emerytalna, rentowa, chorobowa,
                            wypadkowa). Składka zdrowotna jest liczona
                            niezależnie, według zasad właściwych dla wybranej
                            formy opodatkowania.
                          </p>
                        </details>
                        ...
                        <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                          ...
                          <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Maksymalnie 36 miesięcy w ciągu ostatnich 60
                            miesięcy. Po wyczerpaniu limitu trzeba wrócić do
                            pełnego ZUS na co najmniej 24 miesiące, zanim
                            ponownie można skorzystać z ulgi.
                          </p>
                        </details>
                        ...
                        <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                          ...
                          <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Tak. Niższe składki społeczne oznaczają niższą
                            podstawę wymiaru składki emerytalnej. W konsekwencji
                            na koncie emerytalnym w ZUS gromadzi się mniej
                            kapitału, co obniża przyszłą emeryturę.
                          </p>
                        </details>
                        ...
                        <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                          ...
                          <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Tak. Mały ZUS Plus dotyczy składek społecznych i
                            jest niezależny od formy opodatkowania. Możesz
                            łączyć go z ryczałtem, podatkiem liniowym lub skalą
                            podatkową.
                          </p>
                        </details>
                      </div>
