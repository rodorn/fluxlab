            ...
            <article>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    opłacać składki społeczne od niższej podstawy wymiaru.
                    Zamiast standardowej podstawy (60% przeciętnego
                    wynagrodzenia, czyli 5 593,20 zł w 2026), podstawa jest
                    wyliczana na podstawie dochodu z poprzedniego roku
                    kalendarzowego.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Dotyczy to składek: emerytalnej, rentowej, chorobowej i
                    wypadkowej. Nie dotyczy składki zdrowotnej — ta jest liczona
                    niezależnie, według zasad właściwych dla danej formy
                    opodatkowania.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Podstawowa idea jest prosta: jeśli zarabiasz mniej, płacisz
                    mniejsze składki społeczne. Dzięki temu więcej zostaje w
                    kieszeni na bieżącą działalność. Ceną jest jednak niższa
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      Prowadziłeś działalność gospodarczą przez co najmniej 60
                      dni w poprzednim roku kalendarzowym
                    </li>
                    <li>
                      Nie korzystałeś w poprzednim roku z ulgi na start ani z
                      preferencyjnego ZUS (tzw. małego ZUS bez
                      &bdquo;Plus&rdquo;)
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    preferencyjnych składek musisz wrócić do pełnego ZUS na co
                    najmniej 2 lata, zanim ponownie skorzystasz z ulgi.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    60% przeciętnego wynagrodzenia, czyli 5 593,20 zł w 2026
                    roku. Łączne składki społeczne (bez zdrowotnej) od tej
                    podstawy to ok. 1 773 zł miesięcznie.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Na małym ZUS Plus podstawa jest wyliczana z dochodu z
                    poprzedniego roku. Formuła jest następująca: dochód roczny
                    dzielony przez liczbę dni prowadzenia działalności,
                    pomnożony przez 30 — ale nie mniej niż 30% minimalnego
                    wynagrodzenia.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    podstawa wymiaru: (60 000 / 365) × 30 = ok. 4 932 zł. Ale
                    jest ograniczenie — podstawa nie może przekroczyć 60%
                    przeciętnego wynagrodzenia (5 593,20 zł) i nie może być
                    niższa niż 30% minimalnego wynagrodzenia (1 447,80 zł).
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przy dochodzie 5 000 zł/mies. podstawa wyniesie ok. 4 932
                    zł. Składki społeczne od tej podstawy to ok. 1 563 zł
                    miesięcznie.
                  </p>
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    dochodzie 3 000 zł/mies. podstawa spada do ok. 2 959 zł, a
                    składki do ok. 937 zł — oszczędność rośnie do ok. 836 zł
                    miesięcznie (ponad 10 000 zł rocznie).
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Brak składek społecznych (emerytalna, rentowa, chorobowa,
                      wypadkowa)
                    </li>
                    ...
                    <li>
                      Warunek: pierwsza działalność lub przerwa min. 60 miesięcy
                    </li>
                    <li>
                      Brak wpływu na emeryturę (brak składek = brak kapitału)
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      Podstawa: 60% przeciętnego wynagrodzenia (5 593,20 zł w
                      2026)
                    </li>
                    <li>Składki społeczne ok. 1 773 zł/mies.</li>
                    <li>Obowiązuje gdy nie przysługują ulgi</li>
                    <li>
                      Najwyższe składki, ale też najwyższa podstawa emerytalna
                    </li>
                  </ul>
                ...
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    <li>
                      ...
                      ZUS Plus i tak zbliża się do pełnego ZUS — oszczędność
                      jest minimalna
                    </li>
                    <li>
                      Gdy zbliżasz się do wieku emerytalnego — niższe składki
                      oznaczają niższą emeryturę, a czas na
                      &bdquo;nadrobienie&rdquo; jest krótki
                    </li>
                    <li>
                      Gdy zależy Ci na wyższym zasiłku chorobowym lub
                      macierzyńskim — ich wysokość zależy od podstawy wymiaru
                      składek
                    </li>
                    <li>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    składek to 36 miesięcy niższego kapitału emerytalnego. Przy
                    obecnym systemie emerytalnym każdy rok się liczy.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      W ciągu 7 dni od dnia spełnienia warunków — jeśli warunki
                      spełniłeś w trakcie roku (np. po zakończeniu
                      preferencyjnego ZUS)
                    </li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    dla przedsiębiorców z przychodem do 120 000 zł rocznie. Przy
                    niskich dochodach oszczędność sięga kilkuset złotych
                  ...
                  <div className="space-y-4">
                    ...
                    <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                        ...
                        Po wyczerpaniu limitu trzeba wrócić do pełnego ZUS na co
                        najmniej 24 miesiące, zanim ponownie można skorzystać z
                        ulgi.
                      </p>
                    </details>
                    ...
                    <details className="group rounded-2xl border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="px-6 pb-6 text-gray-600 dark:text-gray-400">
                        ...
                        niezależny od formy opodatkowania. Możesz łączyć go z
                        ryczałtem, podatkiem liniowym lub skalą podatkową.
                      </p>
                    </details>
                  </div>
                </div>
