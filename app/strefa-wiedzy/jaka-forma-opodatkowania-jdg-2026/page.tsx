              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    wybierzesz innej, automatycznie rozliczasz się na skali. Jej
                    główna przewaga to kwota wolna od podatku — w 2026 roku
                    wynosi 30 000 zł. Oznacza to, że od pierwszych 30 000 zł
                    dochodu nie płacisz podatku dochodowego wcale.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>
                      Składka zdrowotna 4,9% z odliczeniem do 12 900 zł jest dla
                      Ciebie korzystniejsza niż 9% bez odliczenia na skali
                    </li>
                    <li>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <li>Twoja stawka ryczałtu jest niska (np. 8,5% lub 12%)</li>
                    <li>
                      Nie planujesz dużych inwestycji do odliczenia (sprzęt,
                      samochód)
                    </li>
                    <li>Chcesz prostoty — ryczałt ma uproszczoną ewidencję</li>
                  </ul>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    koszty, to płacisz podatek od pieniędzy, które tak naprawdę
                    wydałeś.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    efektywna składka jest niższa, a łączne obciążenie bardziej
                    przewidywalne.
                  </p>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    daje znaczącą oszczędność. Można ją częściowo odliczyć (50%
                    zapłaconej składki).
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    konkretnych liczb. Użyj kalkulatora, żeby porównać wszystkie
                    trzy formy naraz.
                  </p>
                </div>
              </section>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    koszty prowadzenia działalności, na ryczałcie te koszty nie
                    pomniejszają podstawy opodatkowania. Na skali i liniowym —
                    tak.
                  </p>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    rozliczeniu z małżonkiem. Podatek liniowy — przy wysokich
                    dochodach i dużych kosztach. Ryczałt — przy niskich kosztach
                    i korzystnej stawce.
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Wyboru dokonujesz raz w roku — do 20 lutego. Warto poświęcić
                    godzinę na przeliczenie wariantów, zamiast tracić tysiące
                    złotych przez cały rok.
                  </p>
                </div>
              </section>
