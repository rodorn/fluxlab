    ...
    <>
      ...
      <main className="pt-16 prose-justify">
        ...
        <div className="container-wide pb-20">
          <Tabs
            ariaLabel="Rozdziały artykułu Pipedrive vs Salesforce"
            tabs={[
              {
                label: "Filozofia i cennik",
                content: (
                    ...
                    <div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-16">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          ...
                          zbudowany jest wokół widoku deali i ich przesuwania
                          między etapami. Handlowiec dostaje przejrzysty obraz
                          tego, co ma do zrobienia dziś, a manager widzi
                          pipeline jednym spojrzeniem. To narzędzie do
                          sprzedaży, a nie platforma do wszystkiego.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          Salesforce to ekosystem. Sales Cloud, Service Cloud,
                          Marketing Cloud, Experience Cloud, Data Cloud,
                          AppExchange z tysiącami integracji. Wszystko da się
                          skonfigurować, ale nic nie działa od razu. Każda
                          decyzja wymaga zastanowienia się, jak ułożyć obiekty,
                          profile, role, uprawnienia i automatyzacje.
                        </p>
                      ...
                      <div>
                        ...
                        <p className="mt-6 text-gray-600 dark:text-gray-400 leading-relaxed">
                          ...
                          dodatkowe licencje (Service, Marketing), Sandboxy i
                          pakiety z AppExchange. Realny TCO dla 10 osób w
                          Salesforce Enterprise to kilkukrotnie więcej niż
                          Pipedrive Professional dla tego samego zespołu.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-16">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          ...
                          leady, deale, etapy, aktywności, zadania, e-mail,
                          prosty workflow, raporty pipeline. Ma wbudowanego
                          asystenta AI, generowanie e-maili, prognozy i sygnały
                          aktywności. Wszystko jest tam, gdzie spodziewa się
                          tego handlowiec, który chce po prostu sprzedawać.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          ...
                          marketing automation łączą go zwykle z osobnymi
                          systemami przez integrację albo iPaaS.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                          Salesforce zawiera Marketing Cloud, Account Engagement
                          (dawniej Pardot), Service Cloud i wiele innych
                          modułów. Można pokryć cały lifecycle klienta, ale
                          każdy z tych modułów to osobny produkt z własnym
                          cennikiem i krzywą wdrożenia.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          Pipedrive da się sensownie skonfigurować w 1–2
                          tygodnie: pipeline, pola, użytkownicy, integracja ze
                          skrzynką, podstawowe automatyzacje. Po miesiącu zespół
                          zwykle pracuje już naturalnie.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          Salesforce w wariancie Enterprise to 3–6 miesięcy
                          realnego wdrożenia, jeśli traktować go poważnie.
                          Modelowanie danych, procesów, uprawnień, integracji,
                          raportów. Mniejsze wdrożenia Starter Suite są szybsze,
                          ale wtedy używasz ułamka możliwości platformy.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          Pipedrive ma marketplace z setkami integracji oraz
                          REST API. W praktyce większość MŚP łączy go ze
                    ...
                    <div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-16">
                      ...
                      <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <li className="flex items-start gap-2">
                            <Check />
                            nie chcesz utrzymywać dedykowanego administratora
                            CRM,
                          </li>
                          <li className="flex items-start gap-2">
                            <Check />
                        ...
                        <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                          <li className="flex items-start gap-2">
                            <Check />
                            proces wymaga skomplikowanego modelu danych (np.
                            sprzedaż projektowa, multi-brand, regiony, kanały),
                          </li>
                          <li className="flex items-start gap-2">
                            <Check />
                          ...
                          <li className="flex items-start gap-2">
                            <Check />
                            stać Cię na zespół (lub partnera) utrzymujący
                            platformę.
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          Tu leży jedna z największych różnic między
                          platformami. Pipedrive ma stały zestaw obiektów
                          (Leads, Deals, People, Organizations, Activities,
                          Products, Projects) oraz custom fields. Uprawnienia są
                          uproszczone: zespoły, widoczność danych, role. Dla 90%
                          firm B2B to w zupełności wystarcza.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                          Salesforce idzie dużo dalej. Możesz tworzyć dowolne
                          ...
                          końcowych w roli kierowców.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                          Cena tej elastyczności to konieczność zaprojektowania
                          modelu danych. W Pipedrive „model" często sprowadza
                          się do listy pól w dealu. W Salesforce to osobny
                          dokument architektury, który musi utrzymywać admin lub
                          partner wdrożeniowy. Jeśli go nie masz, platforma
                          szybko zamienia się w chaotyczną kolekcję
                          przypadkowych custom obiektów.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed font-medium">
                          Scenariusz A: agencja marketingowa, 8 osób w
                          sprzedaży.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed font-medium">
                          Scenariusz B: dystrybutor B2B, 25 handlowców, 3
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed font-medium">
                          Scenariusz C: SaaS z 40-osobowym działem sprzedaży,
                          procesem MEDDIC, prognozą per segment i integracjami z
                          billingiem.
                        </p>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                          Salesforce wygrywa wyraźnie. Metodologia MEDDIC jako
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            firmie to często znaczy więcej kosztów i więcej
                            rzeczy do utrzymania bez realnej korzyści. Pipedrive
                            bywa lepszym wyborem właśnie dlatego, że robi mniej.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            Tylko licencje Sales Cloud Enterprise to ok. 1650
                            USD miesięcznie. Do tego dochodzi wdrożenie,
                            integracje, utrzymanie i ewentualne pakiety z
                            AppExchange. Realny roczny TCO często przekracza
                            30–50 tys. USD.
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            Tak, do kilkudziesięciu handlowców pracuje bez
                            problemu. Granicą bywa nie liczba użytkowników,
                            tylko złożoność procesu i potrzeba własnych obiektów
                            oraz głębokich uprawnień.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                            Czy da się zacząć od Pipedrive i przejść na
                            Salesforce?
                          </h3>
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            Tak. Pipedrive AI generuje wiadomości, sugeruje
                            akcje i prognozuje wynik pipeline. To nie jest skala
                            Salesforce Einstein, ale dla typowego B2B zwykle
                            wystarcza.
                          </p>
                        </div>
                        <div>
                    ...
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                      ...
                      <div className="mt-16 rounded-2xl bg-accent/10 p-8 lg:p-12 text-center">
                        <p className="text-lg font-medium text-gray-900 dark:text-white">
                          Wahasz się między Pipedrive a Salesforce dla swojej
                          firmy?
                        </p>
                        <Link
                          href="/automatyzacja-crm"
