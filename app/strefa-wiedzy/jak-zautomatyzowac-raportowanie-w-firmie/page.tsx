            ...
            <article>
              ...
              <section className="py-12 lg:py-16">
                <div className="max-w-3xl mx-auto px-6 lg:px-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Przykład: &bdquo;Liczba leadów&rdquo; może znaczyć wszystko
                    i nic. Czy liczysz każde zapytanie? Tylko unikalne? Tylko
                    kwalifikowane? Bez tej definicji raport będzie mylący
