                  ...
                  <div className="py-6 lg:py-8">
                    <div className="max-w-4xl space-y-6">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed pt-2">
                        ...
                        publikuję tylko po pisemnej akceptacji klienta. Pierwsze
                        pojawią się tutaj w ramach{" "}
                        <Link
                          href="/pilotaz"
                          className="text-accent hover:underline font-medium"
                        >
                  ...
                  <div className="py-6 lg:py-8">
                    <div className="max-w-2xl mx-auto text-center">
                      ...
                      <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        3 firmy B2B otrzymują wdrożenie za 50% ceny w zamian za
                        zgodę na publiczne case study. Publikujemy tylko to, co
                        zaakceptujesz.
                      </p>
