          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-8">
                ...
                sprzedaży. Dla firm leasingowych i brokerów finansowych pojawia
                się 5 czynników, które łamią standardową konfigurację:
              </p>
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Typowa firma brokerska po 3–5 latach na rynku ma trzy bóle
                jednocześnie: lead z porównywarki dociera za późno, dokumentacja
                klienta krąży po skrzynkach, a prowizje są liczone w Excelu z
                opóźnieniem i błędami. Ekosystem partnerów (leasingodawcy,
                ubezpieczyciele) wymusza pracę w 6 portalach, każdy ze swoim
                interfejsem. Generyczny CRM (Pipedrive, HubSpot) tylko częściowo
                łata problem — bo nie umie się wpiąć w BIK, w portale leasingowe
                ani w naliczanie prowizji wieloskładnikowej.
              </p>
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                backoffice, 800 leadów miesięcznie z 6 porównywarek, średnio 80
                wniosków leasingowych miesięcznie. Konwersja z leada na
                zamknięty wniosek 10%. Średnia prowizja 1 200 zł netto.
              </p>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Pierwszy etap automatyzacji (8–15 tys. zł netto) zwraca się w
                pierwszym miesiącu po uruchomieniu, jeśli biuro ma 4+ brokerów i
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto mb-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                miejsca, w których standardowy CRM się kończy, a zaczyna się
                integracja sektora finansowego.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 bg-gray-50 dark:bg-gray-900/50 border-y border-gray-100 dark:border-gray-800">
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Nie zaczynam od pełnej automatyzacji wszystkich 8 leasingodawców
                + prowizji + raportów KNF. Zaczynam od pętli, która zwróci się w
                pierwszym miesiącu i pokaże zarządowi liczbę odzyskanych godzin
                tygodniowo.
              </p>
              <ul className="space-y-3">
                {firstStage.map((s, i) => (
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-8">
                ...
                etapu. Wycenę dostajesz po godzinnym audycie procesu i
                przejrzeniu obecnego stacku.
              </p>
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-2xl p-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    Routing leadów + wzbogacenie + integracja z 1 leasingodawcą
                    + powiadomienia klienta. 3–5 tygodni.
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800/60 border border-accent/30 rounded-2xl p-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    automatyzacja prowizji + raportowanie KNF. 3–6 miesięcy
                    etapami.
                  </p>
                </div>
              </div>
          ...
          <div className="container-wide">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                ...
                wskazaniem 3 najpilniejszych miejsc do automatyzacji i widełkami
                cenowymi. Bez zobowiązań — jeśli nie zobaczę dopasowania, powiem
                to wprost.
              </p>
              <TrackedCTA
                href="/#kontakt"
