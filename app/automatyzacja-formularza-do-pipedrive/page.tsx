                      ...
                      <div className="">
                        <div className="max-w-3xl mx-auto">
                          ...
                          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                            Ręczne przepisywanie leadów ma trzy konsekwencje,
                            których nigdzie nie widać w arkuszu „koszty
                            marketingu”: gubione leady, niespójne dane i
                            opóźnienia w pierwszym kontakcie. Każda z nich
                            kosztuje, ale liczona jest dopiero, jak się policzy.
                            Stąd ten tekst.
                          </p>
                    ...
                    <section className="mt-16 lg:mt-24 pt-16 lg:pt-24 border-t border-gray-100 dark:border-gray-800">
                      <div className="">
                        <div className="max-w-3xl mx-auto">
                          ...
                          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                            Nie trzeba audytu, żeby to zauważyć. Wystarczy, że
                            któreś z poniższych zdań brzmi znajomo:
                          </p>
                          <ul className="space-y-3">
                            {symptoms.map((s) => (
                              <li
                        ...
                        <div className="max-w-3xl mx-auto">
                          ...
                          <div className="bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 mb-6">
                            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                              <strong className="text-gray-900 dark:text-white">
                                300 leadów miesięcznie × 5 minut przepisywania ×
                                60 zł/h ={" "}
                          ...
                          <ul className="space-y-3 mb-6">
                            ...
                            <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                              ...
                              <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                                <strong>
                                  Spadek konwersji przez czas reakcji.
                                </strong>{" "}
                                Lead odebrany w 5 minut konwertuje wielokrotnie
                                lepiej niż odebrany po 4 godzinach. To jest dziś
                                branżowy konsensus, nie marketingowy slogan.
                              </span>
                            </li>
                            <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                              <span className="flex-shrink-0 w-1.5 h-1.5 mt-2.5 rounded-full bg-accent" />
                            ...
                            <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                              ...
                              <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                                ...
                                reklamowego staje się zgadywanką.
                              </span>
                            </li>
                          </ul>
                          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            Jeśli handlowiec przepisuje dane, to nie sprzedaje.
                            Tyle filozofii.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="">
                        <div className="max-w-3xl mx-auto">
                          ...
                          <p className="mt-6 text-gray-700 dark:text-gray-300 leading-relaxed">
                            Każdy etap to potencjalne miejsce zgubienia leada.
                            Sumarycznie: konwersja niższa niż mogłaby być,
                            marketing przepala budżet, a handlowcy klną na CRM.
                          </p>
                        </div>
                      </div>
                    </section>
                              ...
                              <tbody className="text-sm text-gray-700 dark:text-gray-300 divide-y divide-gray-100 dark:divide-gray-700">
                                <tr>
                                  ...
                                  <td className="px-6 py-5 align-top">
                                    ...
                                    organizacja + deal), walidacja, zadanie
                                ...
                                <tr>
                                  ...
                                  <td className="px-6 py-5 align-top">
                                    ...
                                    e-mailu/NIP, routing po regułach, eskalacja,
                                ...
                                <tr>
                                  ...
                                  <td className="px-6 py-5 align-top">
                                    Powyższe + kilka formularzy/landingów/źródeł
                                    reklam, wzbogacanie po NIP, zaawansowane
                                    mapowanie kampanii.
                                  </td>
                                  <td className="px-6 py-5 align-top whitespace-nowrap font-semibold text-accent">
                                    15 — 25 tys. zł
                      ...
                      <div className="">
                        <div className="max-w-2xl mx-auto text-center">
                          ...
                          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                            ...
                            twojej firmie ten jeden kawałek można zamknąć w 2–4
                            dni roboczych. Bez zobowiązań, bez prezentacji w
                            PowerPoincie.
                          </p>
                          <TrackedCTA
                            href="/#kontakt"
