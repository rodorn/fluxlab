      ...
      {loading &&
        (() => {
          const steps = [
            ...
            {
              t: 15,
              text: `Dobieramy warianty paliwowe (benzyna, diesel, LPG)...`,
            },
            { t: 22, text: "Weryfikujemy ceny na polskim rynku..." },
            { t: 30, text: "Prawie gotowe, finalizujemy rekomendacje..." },
            {
              t: 45,
              text: "To trwa dłużej niż zwykle, prosimy o cierpliwość...",
            },
          ];
          const current =
