...
const sections = [
  {
    ...
    effect: [
      "Brak utraconych leadów",
      "Przewidywalność pipeline'u",
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                Automatyzacja Salesforce –<br className="hidden sm:block" />{" "}
                zaawansowane integracje i custom development
              </h1>
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400 mb-8">
                Prawdziwa przewaga zaczyna się tam, gdzie kończy się
                konfiguracja w GUI, a zaczyna architektura procesów, integracje
                i development oparty o API.
              </p>
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Bo Salesforce bez architektury procesowej to tylko drogi CRM.
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="mt-6 text-sm text-gray-500 dark:text-gray-400 italic border-l-2 border-accent/30 pl-3">
                    Celem nie jest konfiguracja CRM, tylko zwiększenie
