          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <h2 className="mt-4 text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                Speed-to-lead to nie luksus — to przewaga, której nie widać w
                tabelce
              </h2>
              <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-4 mb-8">
                <p>
                  W większości firm B2B czas reakcji na leada jest mierzony w
                  godzinach. W najlepszych — w minutach. Różnica między tymi
                  dwoma światami to nie jakość handlowców i nie wysokość budżetu
                  marketingowego. To architektura tego, co dzieje się w
                  pierwszych 30 sekundach po wypełnieniu formularza.
                </p>
                <p>
                  Większość firm nie traci leadów dlatego, że ma zły CRM. Traci
                  je dlatego, że między formularzem a CRM-em jest człowiek
                  robiący za integrację API. Ten człowiek czasem śpi, czasem ma
                  spotkanie, czasem jest na chorobowym. Lead nie czeka.
                </p>
                <p>
                  Skrócenie czasu reakcji nie polega na tym, żeby handlowcy
                  pracowali szybciej. Polega na tym, żeby informacja o nowym
                  leadzie trafiała do właściwej osoby, na właściwym kanale, z
                  właściwym deadline'em — automatycznie.
                </p>
              </div>
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                Te zachowania są w 90% firm B2B i wszyscy je akceptują jako
                normalność. To nie jest normalność — to zaakceptowana strata.
              </p>
              <ul className="space-y-3">
                {symptoms.map((s) => (
                  <li
        ...
        <section className="py-16 lg:py-24">
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-4 mb-8">
                <p>
                  Załóżmy realistyczny scenariusz: firma B2B z 200 leadami
                  miesięcznie, średnia wartość deala 8 000 zł, konwersja z leada
                  na klienta przy reakcji 5 min — 12%, przy reakcji 4 h — 4%.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 lg:p-8 mb-6 space-y-3 font-mono text-sm">
                <p className="text-gray-700 dark:text-gray-300">
                  <span className="text-accent font-semibold">Wolumen:</span>{" "}
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  <span className="text-accent font-semibold">Różnica:</span>{" "}
                  <strong>1 536 000 zł rocznie</strong> — wyłącznie z powodu
                  czasu reakcji
                </p>
                <p className="text-gray-700 dark:text-gray-300 pt-3 border-t border-gray-100 dark:border-gray-700">
                  ...
                  jednorazowo 5–15 tys. zł + 200–500 zł/mies utrzymania
                </p>
                <p className="text-gray-700 dark:text-gray-300">
                  <span className="text-accent font-semibold">ROI:</span> zwykle
                  1–3 miesiące, nawet przy konserwatywnych założeniach konwersji
                </p>
              </div>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Liczby zależą od branży i wartości deala — w leasingu czy
                ubezpieczeniach skala bywa większa, w niskomarżowym e-commerce
                mniejsza. Ale kierunek jest zawsze ten sam:{" "}
                <strong>
                  różnica między 5 min a 4 h to nie kosmetyka — to zwykle
                  kilkadziesiąt procent rocznego przychodu z leadów.
                </strong>
              </p>
            </div>
          </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="mt-4 text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">
                  Jak wygląda obsługa leada przy 4-godzinnej reakcji vs
                  5-minutowej
                </h2>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="mb-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
                  Każdy z tych kroków wykonuje się w pierwszych 30 sekundach od
                  wpadnięcia leada. Handlowiec ma realnie 5 minut na rozmowę —
                  system robi resztę.
                </p>
              </div>
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-4 mb-6">
                <p>
                  Pełen system speed-to-lead z eskalacjami i auto-odpowiedziami
                  to projekt na 2–4 tygodnie. Ale 80% efektu daje najprostsza
                  konfiguracja, którą da się postawić w kilka dni.
                </p>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    <strong>Push + Slack zamiast maila</strong> — od razu
                    przenieś notyfikacje o leadach z poczty na kanał, który
                    handlowcy mają na ekranie. Sam ten ruch potrafi obniżyć czas
                    reakcji o 50%.
                  </span>
                </li>
                <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    <strong>Auto-odpowiedź dla klienta w 30 sekund</strong> —
                    SMS lub mail „dzwonimy do 5 minut”. Klient wie, że jest
                    obsłużony, i nie wysyła zapytania do konkurencji.
                  </span>
                </li>
                <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                  <span className="flex-shrink-0 mt-0.5 w-6 h-6 rounded-full bg-accent text-white flex items-center justify-center text-xs font-bold">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    <strong>SLA 5 minut z licznikiem</strong> — zadanie w CRM z
                    deadline'em i widocznym licznikiem. Bez deadline'u nie ma
                    speed-to-lead.
                  </span>
                </li>
                <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    <strong>Pomiar od dnia 1.</strong> — średni czas pierwszego
                    kontaktu, % leadów w SLA, podział wg godzin. Bez pomiaru nie
                    wiesz, co działa.
                  </span>
                </li>
              </ul>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Dopiero po dwóch tygodniach pracy na żywych danych dokładamy
                eskalacje, routing wielowymiarowy i obsługę po godzinach. Bez
                pomiarów z pierwszego etapu te kolejne kroki to zgadywanie.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                ...
                speed-to-lead&rdquo; — ale dane mówią co innego. Każdy z nich da
                się obejść, jeśli wiesz, że istnieje.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 lg:p-8">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    auto-odpowiedź dla klienta, SLA z licznikiem, podstawowy
                    raport. Wdrożenie 3–5 dni.
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800/60 border border-accent/40 rounded-2xl p-6 lg:p-8 shadow-sm">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    Kilka źródeł, routing wielowymiarowy, eskalacje, obsługa po
                    godzinach pracy, integracja z kalendarzami, pełny raport
                    speed-to-lead per handlowiec / źródło. Wdrożenie 2–4
                    tygodnie.
                  </p>
                </div>
              </div>
