      ...
      <main className="pt-16">
        ...
        <section className="py-16 lg:py-24 border-t border-gray-100 dark:border-gray-800">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
                Kalkulator porównuje trzy scenariusze: ręczna obsługa (status
                quo), zatrudnienie kolejnej osoby (etat orientacyjnie),
                wdrożenie automatyzacji (zakres rynkowy). Logika decyzyjna
                patrzy na dwa wymiary: powtarzalność i częstotliwość.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  ...
                  miesięcznie. To stawka × pełny etat (168 h/mies.) — minimum
                  bez ZUS-u, urlopu, sprzętu i kosztów rekrutacji. Realny pełen
                  koszt zatrudnienia jest wyższy o 30–50%.
                </li>
                <li>
                  <strong>Automatyzacja orientacyjnie</strong>: 1 500–8 000 zł
                  jednorazowo + 0–200 zł/mies. utrzymania. Konkretna kwota
                  zależy od liczby integracji, logiki warunkowej i tego, czy
                  trzeba parsować dane wejściowe (maile, PDF-y).
                </li>
                <li>
                  <strong>Sygnał decyzyjny</strong>: jeśli proces jest
                  powtarzalny i występuje codziennie / kilka razy w tygodniu —
                  mocna rekomendacja automatyzacji. Jeśli nie jest powtarzalny —
                  ręcznie (automatyzacja niestabilnego procesu = ciągłe
                  dopisywanie wyjątków). Jeśli skala jest mała (poniżej 5
                  h/mies. i okazjonalnie) — ręcznie. W pozostałych przypadkach
              ...
              <p>
                ...
                . Przy realistycznej średniej wdrożenia ~4 750 zł i koszcie
                ręcznej pracy 2 400 zł/mies. zwrot jest w ~2 miesiące. To bardzo
                zgrubny szacunek — w diagnozie liczę pod konkretny proces, z
        ...
        <section className="py-12 lg:py-16">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
                Automatyzacja nie jest odpowiedzią na wszystko. Są sytuacje, w
                których dodatkowa osoba jest lepszym wyborem — i to nawet z
                punktu widzenia czystej matematyki, nie tylko „bo lubię ludzi”.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Proces wymaga osądu</strong>: negocjacje,
                  niestandardowe oferty, decyzje obarczone ryzykiem
                  reputacyjnym. Tu automat daje gorsze wyniki niż średnio
                  kompetentny człowiek.
                </li>
                <li>
                  <strong>Proces ciągle się zmienia</strong>: nowy regulator,
                  nowe wytyczne klienta, zmieniające się systemy partnerów.
                  Każda zmiana = koszt modyfikacji automatu.
                </li>
                <li>
                  <strong>Skala jest mała</strong>: pojedyncze zdarzenia w
                  miesiącu nie uzasadniają inwestycji we wdrożenie. Tu osoba
                  wykonująca to przy okazji innych zadań jest tańsza i bardziej
                  elastyczna.
                </li>
                <li>
                  <strong>Brakuje danych wejściowych</strong>: proces opiera się
                  na intuicji handlowca, kontekście rozmowy, niedoprecyzowanych
                  wymaganiach. Automatyzacja zadziała dopiero, gdy
                  ustabilizujesz dane.
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>
                    Proces powtarzalny, codzienny, z jasnym wejściem i wyjściem.
                  </strong>{" "}
                  Klasyk: formularz www → CRM, faktura cykliczna, follow-up po X
                  dniach. Wdrożenie zwraca się zwykle w 1–4 miesiące.
                </li>
                <li>
                  <strong>Czas reakcji ma duże znaczenie biznesowe.</strong>{" "}
                  Lead, który czeka 2 godziny na odpowiedź, ma wielokrotnie
                  mniejszą szansę zostać klientem niż ten obsłużony w 5 minut.
                  Automat odpowiada zawsze, w tym samym czasie.
                </li>
                <li>
                  <strong>
                    Proces wymaga przepisywania danych między systemami.
                  </strong>{" "}
                  Jeśli handlowiec kopiuje dane z formularza do CRM, do arkusza,
                  do Slacka — to jest dokładnie ten typ pracy, który jest tańszy
                  automatycznie i dokładniejszy.
                </li>
                <li>
                  <strong>Skala rośnie szybciej niż możesz zatrudniać.</strong>{" "}
                  Automatyzacja skaluje się liniowo bez kosztu marginalnego. Dwa
                  razy więcej leadów = ten sam koszt automatu, dwukrotny koszt
                  zespołu.
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <div className="bg-accent/5 dark:bg-accent/10 border border-accent/20 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                W diagnozie 30-minutowej liczę pełny koszt obecnego procesu,
                koszt wdrożenia automatyzacji i punkt zwrotu — pod Twoje
                konkretne narzędzia.
              </p>
              <TrackedCTA
                href="/#kontakt"
              ...
              {[
                {
                  ...
                  title: "Automatyzacja vs zatrudnienie — pełny artykuł",
                  description:
          ...
          <div className="max-w-2xl mx-auto px-6 lg:px-8 text-center">
            <div className="bg-accent/5 dark:bg-accent/10 border border-accent/20 rounded-2xl p-10">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-8">
                W diagnozie dostaniesz pełen koszt obecnego procesu, koszt
                wdrożenia, punkt zwrotu i konkretną listę kroków — albo
                rekomendację, że nie warto.
              </p>
              <TrackedCTA
                href="/#kontakt"
