                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                        Pierwsze pytanie nie brzmi: „Make czy n8n?”. Pierwsze
                        pytanie brzmi: „który proces CRM-owy powtarza się często
                        i kosztuje nas czas albo sprzedaż?”. Dopiero kiedy mamy
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                        Realny przypadek: zespół 4 handlowców, 600 leadów
                        miesięcznie, ręczne wpisywanie do CRM zajmuje średnio 8
                        minut na lead (z wzbogaceniem). Manager klei raport
                        tygodniowy 4 godziny w każdy piątek. To wszystko bez
                        liczenia utraconych deali przez wolny czas reakcji.
                      </p>
                      ...
                      <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-2xl p-6">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
                            ...
                            firmie, dane mogą leżeć w UE u dostawcy SaaS.
                          </p>
                        ...
                        <div className="bg-white dark:bg-gray-800/60 border border-accent/30 rounded-2xl p-6">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
                            Macie osobę techniczną (lub partnera na retainerze),
                            wolumen rośnie powyżej 30 tys. operacji,
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            biznesową i nie chcecie być uzależnieni od planu
                            cenowego dostawcy SaaS przy skalowaniu.
                          </p>
                        </div>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <div className="max-w-3xl mx-auto">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-2xl p-6">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                            Routing leadów + wzbogacenie + tworzenie w CRM +
                            prosty raport. 2–3 tygodnie.
                          </p>
                        </div>
                        <div className="bg-white dark:bg-gray-800/60 border border-accent/30 rounded-2xl p-6">
                          <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
