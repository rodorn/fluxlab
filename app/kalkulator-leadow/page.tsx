      ...
      <main className="pt-16">
        ...
        <section className="py-16 lg:py-24 border-t border-gray-100 dark:border-gray-800">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                Realny koszt ręcznej obsługi leadów składa się z dwóch pozycji:
                czasu pracy ludzi i utraconej sprzedaży. Pierwsza pojawia się na
                liście płac, druga jest niewidoczna — i właśnie dlatego boli
                najbardziej.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  ...
                  . Czyste minuty × stawka godzinowa osoby obsługującej.
                </li>
                <li>
                  ...
                  . Zakładamy konserwatywnie, że 30% leadów z opóźnioną reakcją
                  realnie nie konwertuje — i to jest Twoja utracona sprzedaż.
                </li>
                <li>
              ...
              <p>
                ...
                uwzględniam też koszt błędów w danych, ręczne raportowanie, czas
                reakcji na leada premium i utratę pozycji negocjacyjnej przy
                spóźnionym kontakcie. Ale już sama suma „czas + zgubieni
                klienci” zwykle wystarczy, żeby decyzja o automatyzacji była
                oczywista.
              </p>
            </div>
          </div>
        ...
        <section className="py-12 lg:py-16">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                Kalkulator przyda się każdemu, kto podejrzewa, że firma traci
                pieniądze na ręcznej obsłudze leadów, ale nie ma policzonej
                skali problemu. Najczęściej korzystają z niego:
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>
                  ...
                  — zwłaszcza w leasingu, finansach, brokerstwie, dealerach aut,
                  agencjach marketingowych i konsultingu.
                </li>
                <li>
                  <strong>Szefowie sprzedaży</strong>, którzy widzą, że
                  handlowcy więcej czasu spędzają na klikaniu w CRM niż na
                  rozmowach z klientami.
                </li>
                <li>
                  <strong>
                    Osoby decyzyjne rozważające wdrożenie automatyzacji
                  </strong>{" "}
                  — kalkulator daje konkretną liczbę do przedstawienia
                  zarządowi.
                </li>
                <li>
                  <strong>Solopreneurzy i małe zespoły</strong>, którzy wiedzą,
                  że marnują wieczory na przepisywanie danych z maili do
                  arkusza, ale nie wiedzą, czy to jest jeszcze 200 zł/mies., czy
                  już 2 000 zł/mies.
                </li>
              </ul>
              <p>
                Jeśli prowadzisz proces obsługi leadów i chcesz zobaczyć, jak
                może wyglądać po automatyzacji, sprawdź{" "}
                <Link
                ...
                — pokazuję tam, co konkretnie da się usunąć w 1. etapie.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <div className="bg-accent/5 dark:bg-accent/10 border border-accent/20 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                W diagnozie pokazuję, które kroki da się usunąć i jaki ROI ma
                automatyzacja u Ciebie.
              </p>
              <TrackedCTA
                href="/#kontakt"
