                    ...
                    <div className="max-w-3xl space-y-12">
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          ...
                          <p>
                            Wyniki są pokazywane obok siebie, żebyś mógł od razu
                            zobaczyć różnicę. Forma, która daje najwięcej na
                            rękę, jest oznaczona jako najkorzystniejsza. Możesz
                            przełączać widok między wartościami miesięcznymi i
                            rocznymi.
                          </p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Kalkulator pokazuje trzy kolumny: skalę, liniowy i
                            ryczałt. Dla każdej formy widzisz podatek, składki
                            ZUS, składkę zdrowotną, VAT (jeśli dotyczy) i kwotę
                            do dyspozycji.
                          </p>
                          <p>
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl space-y-12">
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Kalkulator jest przeznaczony dla osób prowadzących
                            jednoosobową działalność gospodarczą (JDG) lub
                            planujących jej założenie. Sprawdzi się szczególnie,
                            gdy:
                          </p>
                          <ul className="list-disc pl-5 space-y-2">
                            <li>
                              zakładasz firmę i nie wiesz, którą formę
                              opodatkowania wybrać,
                            </li>
                            <li>
                              rozważasz zmianę formy na kolejny rok podatkowy,
                            </li>
                            <li>
                              chcesz sprawdzić, czy ryczałt nadal się opłaca po
                              zmianie kosztów,
                            </li>
                            <li>
                              planujesz przejście z etatu na B2B i chcesz
                              porównać kwotę netto,
                            </li>
                            <li>
                              chcesz zobaczyć wpływ samochodu firmowego, VAT lub
                              ulg ZUS na wynik.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Kalkulator uwzględnia najważniejsze elementy
                            wpływające na opłacalność formy opodatkowania:
                          </p>
                          <ul className="list-disc pl-5 space-y-2">
                            <li>
                              <strong>Trzy formy opodatkowania:</strong> skala
                              podatkowa (12%/32%), podatek liniowy (19%),
                            ...
                            <li>
                              <strong>Składka zdrowotna:</strong> osobno dla
                              każdej formy, według zasad obowiązujących w 2026.
                            </li>
                            <li>
                              <strong>VAT:</strong> czynny (23%), zwolniony
                              podmiotowo, marża.
                            </li>
                            <li>
                              <strong>Koszty prywatne:</strong> telefon,
                              internet i inne wydatki używane częściowo
                              prywatnie.
                            </li>
                            <li>
                              <strong>Samochód:</strong> firmowy (100%
                              odliczenia) lub mieszany (75% PIT, 50% VAT).
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Kalkulator jest modelem uproszczonym. Nie
                            uwzględnia:
                          </p>
                          <ul className="list-disc pl-5 space-y-2">
                            <li>rozliczenia wspólnego z małżonkiem,</li>
                            <li>
                              ulg podatkowych poza ulgą na start i małym ZUS
                              Plus (np. IP Box, ulga B+R),
                            </li>
                            <li>przychodów z kilku źródeł jednocześnie,</li>
                            <li>
                              specyficznych stawek ryczałtu zależnych od PKD,
                            </li>
                            <li>zmian stawek w trakcie roku,</li>
                            <li>zaliczek kwartalnych vs miesięcznych.</li>
                          </ul>
                          <p>
                            Dlatego traktuj wynik jako punkt wyjścia do rozmowy
                            z księgowym, a nie jako ostateczną odpowiedź.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl space-y-12">
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Ryczałt wydaje się prosty i tani, ale nie zawsze
                            wygrywa. Przegrywa najczęściej wtedy, gdy:
                          </p>
                          <ul className="list-disc pl-5 space-y-2">
                            <li>
                              koszty działalności są wysokie (np. materiały,
                              podwykonawcy, wynajem),
                            </li>
                            <li>stawka ryczałtu jest wysoka (15% lub 17%),</li>
                            <li>
                              firma ponosi duże koszty samochodu, sprzętu lub
                              usług,
                            </li>
                            <li>
                              przedsiębiorca chce odliczać składkę zdrowotną od
                              dochodu.
                            </li>
                          </ul>
                          <p>
                            W takich przypadkach podatek liniowy 19%, który
                            pozwala odliczać koszty i częściowo składkę
                            zdrowotną, może dać lepszy wynik netto. Wpisz swoje
                            dane w kalkulatorze (zakładka „Kalkulator”), żeby
                            zobaczyć różnicę na konkretnych liczbach.
                          </p>
                          <p>
                      ...
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            <strong>Patrzenie tylko na stawkę podatku.</strong>{" "}
                            Stawka to nie wszystko. Składka zdrowotna, możliwość
                            odliczenia kosztów i ZUS mogą zmienić wynik o kilka
                            tysięcy złotych rocznie.
                          </p>
                          <p>
                            <strong>Ignorowanie składki zdrowotnej.</strong> Na
                            ryczałcie zdrowotna zależy od przychodu, na liniowym
                            od dochodu, a na skali od dochodu bez możliwości
                            odliczenia. To potrafi być duża różnica.
                          </p>
                          <p>
                            <strong>
                              Założenie, że ryczałt zawsze jest najtańszy.
                            </strong>{" "}
                            Przy wysokich kosztach i wyższych stawkach ryczałtu
                            liniowy potrafi dać lepszy wynik.
                          </p>
                          <p>
                            <strong>Brak uwzględnienia VAT.</strong> Jeśli firma
                            jest czynnym VAT-owcem, to wpływa na cashflow i na
                            to, jak liczyć realny przychód.
                          </p>
                          <p>
                            <strong>Porównywanie form na zły okres.</strong>{" "}
                            Forma opodatkowania dotyczy całego roku. Porównuj
                            roczne kwoty, nie miesięczne w oderwaniu od
                            kontekstu.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40 p-6 space-y-4 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <p>
                              Przeciętne wynagrodzenie: 9 322 zł, minimalne
                              wynagrodzenie: 4 826 zł
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          {[
                            ...
                            },
                            {
                              ...
                              description:
                                "Zasady 2026 dla skali, liniowego i ryczałtu.",
                            },
                            {
