                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl">
                      ...
                      <div className="space-y-4 text-gray-600 dark:text-gray-400">
                        <p>
                          Koszt posiadania samochodu składa się z sześciu
                          komponentów, które kalkulator sumuje rocznie, dzieli
                          na miesiące i rozkłada na każdy przejechany kilometr.
                          Dzięki temu dwa auta, które na papierze kosztują
                          podobnie, okazują się w rzeczywistości różnić o 10–15
                          tys. zł rocznie.
                        </p>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>
                            <strong>Paliwo.</strong> Liczone jako roczny
                            przebieg × realne zużycie na 100 km × cena paliwa.
                            Używaj mediany z Spritmonitor albo z własnych
                            tankowań, nie danych producenta — różnica potrafi
                            wynosić 15–25%.
                          </li>
                          <li>
                            <strong>Olej i płyny.</strong> Wymiana co 15–30 tys.
                            km lub raz w roku, plus filtry i sezonowe
                            uzupełnienia. Dla auta osobowego to 400–800 zł
                            rocznie.
                          </li>
                          <li>
                            <strong>Opony.</strong> Komplet letnich + zimowych
                            wymieniany co 3–4 lata plus dwa przekładania
                            sezonowe. Roczny koszt 1 500–4 000 zł zależnie od
                            segmentu.
                          </li>
                          <li>
                            <strong>Serwis i przeglądy.</strong> Przeglądy
                            okresowe (1–2 rocznie), naprawy bieżące, klocki,
                            tarcze, części eksploatacyjne. Dla 4–8‑letniego auta
                            segmentu C zakładamy 2 000–4 000 zł rocznie.
                          </li>
                          <li>
                            <strong>Ubezpieczenie.</strong> OC + AC + NNW w
                            skali rocznej, zgodnie z Twoją rzeczywistą polisą.
                          </li>
                          <li>
                            <strong>Utrata wartości (amortyzacja).</strong>{" "}
                            Różnica między obecną wartością auta a szacowaną
                            wartością za rok. Typowo 15–20% w pierwszym roku,
                            8–12% rocznie potem.
                          </li>
                        </ul>
                        <p>
                          Źródła danych referencyjnych: średnie ceny paliw
                          (e‑petrol.pl, orlen.pl), mediany zużycia
                          (Spritmonitor.de, autocentrum.pl), aktualne cenniki
                          części (motointegrator, emex), wyceny rynkowe aut
                          używanych (Otomoto, Auto‑Świat, Eurotax). Każdą z tych
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl space-y-12">
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Kalkulator przyda się wszędzie tam, gdzie decyzja o
                            samochodzie wiąże się z realnymi pieniędzmi — a nie
                            tylko z wrażeniem „fajnie się prowadzi”. Najczęściej
                            korzystają z niego cztery grupy osób:
                          </p>
                          <ul className="list-disc pl-5 space-y-2">
                            <li>
                              <strong>
                                Właściciele firm i JDG rozważający zakup auta
                                służbowego.
                              </strong>{" "}
                              Zanim podpiszesz umowę leasingu, warto wiedzieć,
                              ile realnie będzie kosztować utrzymanie auta przez
                              cały okres finansowania — nie tylko rata.
                            </li>
                            <li>
                              <strong>
                                Osoby porównujące leasing z zakupem za gotówkę.
                              </strong>{" "}
                              Leasing zamienia amortyzację na ratę — kalkulator
                              pokazuje realny koszt niezależnie od formy
                              finansowania i pozwala porównać oba scenariusze na
                              tych samych założeniach.
                            </li>
                            <li>
                              <strong>
                                Pracownicy na „autach służbowych”.
                              </strong>{" "}
                              Sprawdź, czy benefit w postaci auta firmowego
                              naprawdę Ci się opłaca w porównaniu z ekwiwalentem
                              pieniężnym i własnym autem.
                            </li>
                            <li>
                              <strong>Kierowcy wymieniający auto.</strong>{" "}
                              Porównaj dwa modele, które wpadły Ci w oko. Często
                              auto droższe w zakupie okazuje się tańsze w
                              całkowitym koszcie dzięki wolniejszej utracie
                              wartości.
                            </li>
                          </ul>
                          <p>
                            Jeśli prowadzisz JDG i chcesz sprawdzić, jak auto
                            wpłynie na Twoje rozliczenie,{" "}
                            <Link
                            ...
                            uwzględnia samochód firmowy i mieszany w każdej z
                      ...
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            Przeciętny kierowca w Polsce zakłada, że auto
                            kosztuje go „tyle, ile rata plus paliwo”. To jest
                            pomyłka o 30–50% w dół. Rzeczywisty koszt posiadania
                            (TCO — Total Cost of Ownership) uwzględnia dodatkowo
                            amortyzację, serwis, opony i ubezpieczenie, które
                            razem stanowią połowę rachunku.
                          </p>
                          <p>
                            Przykład: auto za 120 000 zł z ratą leasingową 2 200
                            zł i paliwem 600 zł miesięcznie wydaje się kosztować
                            2 800 zł/mies. Realnie, po doliczeniu ubezpieczenia
                          ...
                          <p>
                            ...
                            finansowy i na decyzje o flocie. Jeśli zarządzasz
                            3–5 autami, nieświadome niedoszacowanie kosztu o 1
                            000 zł/mies. na auto to 36–60 tys. zł rocznie, które
                            znikają z rachunku zysków i strat bez Twojej
                            kontroli. Dobry model TCO pozwala świadomie wybierać
                            między segmentami, napędami i formami finansowania —
                            i negocjować twardo z dealerami.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl space-y-12">
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            <strong>Pomijanie amortyzacji.</strong> To
                            najczęstszy i najdroższy błąd. Amortyzacja to zwykle
                          ...
                          <p>
                            <strong>
                              Zużycie paliwa z reklamy lub karty katalogowej.
                            </strong>{" "}
                            WLTP i NEDC są w najlepszym razie optymistyczne, w
                            najgorszym oderwane od rzeczywistości. Realne
                            zużycie jest wyższe o 15–25%. Przy 15 tys. km
                            rocznie to różnica 200–400 zł miesięcznie.
                          </p>
                          <p>
                            <strong>Niedoszacowanie kosztu opon.</strong>{" "}
                            „Przecież opony kupuje się raz na kilka lat” — tak,
                            ale to komplet za 3–5 tys. zł plus sezonowa wymiana
                            2× rocznie. W skali miesiąca to realnie 150–300 zł,
                            nie 50 zł, które zwykle zakłada przeciętny
                            właściciel.
                          </p>
                          <p>
                            <strong>
                              Zakładanie stałego serwisu przez cały okres.
                            </strong>{" "}
                            Pierwsze 3 lata nowego auta to głównie przeglądy i
                            oleje. Po przebiegu 100–150 tys. km zaczynają się
                            tarcze, klocki, zawieszenie, wymiany rozrządu,
                            drobne naprawy. Jeśli planujesz trzymać auto długo,
                            uwzględnij rosnącą krzywą kosztów.
                          </p>
                          <p>
                            <strong>Ignorowanie kosztu kapitału.</strong> Jeśli
                            wydałeś 100 000 zł na auto, nie zarabiasz na tych
                            pieniądzach. Przy oprocentowaniu lokaty 4–5% to 4–5
                            tys. zł rocznie „niewidocznego” kosztu. W
                            kalkulatorze możesz go dodać do amortyzacji albo
                            uwzględnić jako osobną pozycję w analizie.
                          </p>
                          <p>
                            <strong>Porównywanie rat zamiast TCO.</strong> „Ten
                            leasing ma ratę 1 800, a tamten 2 200”. OK, a wykup?
                            A pakiet serwisowy? A ubezpieczenie? A dopuszczalny
                            przebieg? Dopiero TCO liczone na pełny okres umowy
                            daje realny obraz.
                          </p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                          <p>
                            <strong>
                              Patrz na koszt na kilometr, nie na miesiąc.
                            </strong>{" "}
                            Miesięczny koszt rośnie liniowo z przebiegiem. Jeśli
                            jeździsz 8 tys. km rocznie, a ktoś 25 tys. km,
                            porównywanie miesięcznych kwot nie ma sensu. Koszt
                            na kilometr pokazuje, ile realnie płacisz za każdą
                            przejechaną trasę.
                          </p>
                          <p>
                            <strong>
                              Porównuj dwa scenariusze, nie jeden w próżni.
                            </strong>{" "}
                          ...
                          <p>
                            <strong>
                              Uwzględnij koszt czasu, a nie tylko pieniędzy.
                            </strong>{" "}
                          ...
                          <p>
                            <strong>
                              Nie zapomnij o kosztach jednorazowych.
                            </strong>{" "}
                      ...
                      <div className="bg-accent/5 dark:bg-accent/10 border border-accent/20 rounded-2xl p-8 text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mb-6">
                          Zanim policzysz koszty, warto zawęzić listę modeli do
                          takich, które realnie pasują do Twoich potrzeb.
                        </p>
                        <Link
