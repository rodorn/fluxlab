        ...
        <div id="sekcje" className="scroll-mt-20 container-wide pb-20">
          <Tabs
            ...
            tabs={[
                    ...
                    <div className="prose prose-gray dark:prose-invert max-w-none space-y-10 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      ...
                      <section>
                        ...
                        <p className="mt-2">
                          ...
                          Regulaminu. Jeśli nie zgadzasz się z jego
                          postanowieniami, prosimy o niekorzystanie z Serwisu.
                        </p>
                      </section>
                      ...
                      <section>
                        ...
                        <p>
                          Serwis służy do prezentacji oferty Usługodawcy w
                          zakresie automatyzacji procesów biznesowych, wdrożeń
                          CRM, integracji API, automatyzacji raportowania oraz
                          powiązanych usług konsultingowych dla firm B2B. Za
                          pośrednictwem Serwisu użytkownicy mogą:
                        </p>
                        <ul className="list-disc pl-6 mt-2 space-y-1">
                          <li>Zapoznać się z ofertą i zakresem usług.</li>
                          <li>
                            Przesłać zapytanie za pośrednictwem formularza
                            kontaktowego.
                          </li>
                          <li>
                            Przeglądać materiały informacyjne dotyczące
                            automatyzacji procesów biznesowych.
                          </li>
                        </ul>
                        <p className="mt-2">
                          Szczegółowy zakres, warunki realizacji i wynagrodzenie
                          za usługi konsultingowe ustalane są indywidualnie w
                          odrębnej umowie zawieranej między Usługodawcą a
                          klientem.
                        </p>
                      </section>
                      ...
                      <section>
                        ...
                        <ul className="list-disc pl-6 mt-2 space-y-1">
                          <li>
                            Korzystania z Serwisu zgodnie z obowiązującymi
                            przepisami prawa i niniejszym Regulaminem.
                          </li>
                          <li>
                          ...
                          <li>
                            Podawania prawdziwych danych w formularzu
                            kontaktowym.
                          </li>
                        </ul>
                      </section>
              ...
              {
                label: "§4–6 · Prawa i odpowiedzialność",
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="prose prose-gray dark:prose-invert max-w-none space-y-10 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      {/* 4 */}
                      <section>
                        ...
                        <p className="mt-2">
                          ...
                          materiałów z Serwisu w celach komercyjnych bez
                          pisemnej zgody Usługodawcy jest zabronione.
                        </p>
                      </section>
                      ...
                      <section>
                        ...
                        <p>
                          ...
                          zamieszczone w Serwisie były aktualne i rzetelne,
                          jednak nie ponosi odpowiedzialności za:
                        </p>
                        <ul className="list-disc pl-6 mt-2 space-y-1">
                          <li>
                            Czasową niedostępność Serwisu wynikającą z przyczyn
                            technicznych, konserwacji lub działania siły
                            wyższej.
                          </li>
                          <li>
                            Skutki wynikające z korzystania z informacji
                            zamieszczonych w Serwisie w sposób niezgodny z ich
                            przeznaczeniem.
                          </li>
                          <li>
                            Działania osób trzecich mogące wpłynąć na
                            funkcjonowanie Serwisu.
                          </li>
                        </ul>
                        <p className="mt-2">
                          W maksymalnym zakresie dopuszczalnym przez
                          obowiązujące prawo odpowiedzialność Usługodawcy za
                          szkody związane z korzystaniem z Serwisu jest
                          wyłączona.
                        </p>
                      </section>
                    ...
                    <div className="prose prose-gray dark:prose-invert max-w-none space-y-10 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      ...
                      <section>
                        ...
                        <p>
                          ...
                          za pośrednictwem formularza kontaktowego. Usługodawca
                          rozpatrzy reklamację w terminie 14 dni od dnia jej
                          otrzymania i poinformuje użytkownika o wyniku
                          rozpatrzenia.
                        </p>
                      </section>
                      ...
                      <section>
                        ...
                        <p>
                          Niniejszy Regulamin podlega prawu polskiemu. Wszelkie
                          spory wynikające z korzystania z Serwisu będą
                          rozstrzygane przez sąd właściwy miejscowo dla siedziby
                      ...
                      <section>
                        ...
                        <p>
                          ...
                          niniejszego Regulaminu. O istotnych zmianach
                          użytkownicy zostaną poinformowani za pośrednictwem
                          Serwisu. Aktualna wersja Regulaminu jest zawsze
