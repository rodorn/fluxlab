                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                        Pipedrive nie został zaprojektowany jako narzędzie
                        raportowe. Jest świetny do prowadzenia pipeline'u i
                      ...
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                        ...
                        stratą spójności. Każdy tydzień wygląda inaczej, bo ktoś
                        inny robi raport, ktoś inny wpisuje formuły, ktoś inny
                        ignoruje 30% dealów z pustym źródłem. Po pół roku
                        takiego trybu nikt już nie wie, co naprawdę pokazują
                        liczby.
                      </p>
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                        Wystarczy, że któreś z poniższych zdań brzmi jak twoja
                        firma. Im więcej trafień, tym pilniejszy temat:
                      </p>
                      <ul className="space-y-3">
                        {symptoms.map((s) => (
                          <li
                    ...
                    <div className="max-w-3xl mx-auto">
                      ...
                      <ul className="space-y-3 mb-6">
                        <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                          <span className="flex-shrink-0 w-1.5 h-1.5 mt-2.5 rounded-full bg-accent" />
                          <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            <strong>Spóźnione decyzje.</strong> Raport
                            tygodniowy w piątek znaczy, że problem zauważasz 5
                            dni za późno. W sprzedaży 5 dni to różnica między
                            domkniętym a przegranym deal'em.
                          </span>
                        </li>
                        <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                          <span className="flex-shrink-0 w-1.5 h-1.5 mt-2.5 rounded-full bg-accent" />
                          <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            <strong>Błędne decyzje.</strong> Liczby z różnych
                            raportów się nie zgadzają. Zarząd wybiera tę, która
                            pasuje do narracji, a niekoniecznie tę, która jest
                            prawdziwa.
                          </span>
                        </li>
                        <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                          ...
                          <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            <strong>
                              Marketing i sprzedaż mówią innymi językami.
                            </strong>{" "}
                            Bez wspólnego źródła danych nikt nie wie, które
                            kampanie zamykają deale, a budżet reklamowy wydaje
                            się „na czuja”.
                          </span>
                        </li>
                        <li className="flex items-start gap-3 bg-white dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700 rounded-xl px-5 py-4">
                          <span className="flex-shrink-0 w-1.5 h-1.5 mt-2.5 rounded-full bg-accent" />
                          <span className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            <strong>Bus factor równy jeden.</strong> Raport jest
                            w głowie jednej osoby. Urlop tej osoby = brak
                            raportów. To nie jest skalowanie firmy, to budowanie
                            kuli śnieżnej.
                          </span>
                        </li>
                      </ul>
                ...
                content: (
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                        Klasyczny piątek w firmie B2B, gdzie raporty robi się
                        ręcznie:
                      </p>
                    ...
                    <div className="container-wide">
                      <div className="max-w-2xl mb-10">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
                          Nie chodzi o jeden „magiczny dashboard”. Chodzi o
                          łańcuch: Pipedrive → warstwa danych → wyliczenia →
                          raporty. Każdy element osobno mierzalny, każdy można
                          zbudować niezależnie.
                        </p>
                      </div>
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-3xl mx-auto">
                      ...
                      <p className="mt-6 text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        tygodnie i decydujemy, co dalej. Zwykle drugi etap wraca
                        w temacie „a teraz dołóżmy źródła leadów i prognozę”.
                      </p>
                    </div>
                  </div>
                ),
                          ...
                          <tbody className="text-sm text-gray-700 dark:text-gray-300 divide-y divide-gray-100 dark:divide-gray-700">
                            <tr>
                              ...
                              <td className="px-6 py-5 align-top">
                                ...
                                dashboard pipeline'u, walidacja kompletności
                            ...
                            <tr>
                              ...
                              <td className="px-6 py-5 align-top">
                                ...
                                reakcji, performance handlowców, prognoza
                            ...
                            <tr>
                              ...
                              <td className="px-6 py-5 align-top">
                                Powyższe + integracja z marketingiem (UTM,
                                kampanie, koszty), księgowością (faktury,
                                płatności), call center, dedykowane dashboardy w
                  ...
                  <div className="py-10 lg:py-12">
                    <div className="max-w-2xl mx-auto text-center">
                      ...
                      <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        30 minut konsultacji wystarczy, żeby określić, czy w
                        twojej firmie pierwszy etap automatycznego raportowania
                        można zamknąć w 3–5 dni. Bez zobowiązań, bez prezentacji
                        w PowerPoincie.
                      </p>
                      <TrackedCTA
                        href="/#kontakt"
